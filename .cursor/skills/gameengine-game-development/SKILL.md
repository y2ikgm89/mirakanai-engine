...
| Detailed reference | `.claude/skills/gameengine-game-development/references/full-guidance.md` |
| Codex | `.agents/skills/gameengine-game-development/SKILL.md` |
| Baseline | `AGENTS.md` |

Read the Claude router first. Load the detailed reference from the table only when exact API names, validation counters, retained ids, package lanes, or mobile/desktop validation recipes are required.
