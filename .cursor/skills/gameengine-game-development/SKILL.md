...
Generated quest/dialogue documents should use `mirakana::runtime::RuntimeQuestDialogueDocument`, `RuntimeQuestDialogueValidationContext`, and `validate_runtime_quest_dialogue_document` before game-owned narrative, tutorial, progression, or objective systems execute. Keep story text, rewards/actions, quest progression state, UI rendering, localization catalogs, scripting, and editor graph tooling game-owned unless a later engine phase explicitly promotes them.
