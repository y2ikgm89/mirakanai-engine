...
| OpenEXR | https://www.openexr.com/ | 2026-06-16 | 3.4.10 via vcpkg baseline `3909e67a639d426ea939d9bff77bfe1d10443476` | Academy Software Foundation, Industrial Light & Magic, and OpenEXR contributors | BSD-3-Clause | No first-party modifications | Optional `asset-importers` OpenEXR HDR source dependency/legal/bootstrap gate |
| Imath | https://github.com/AcademySoftwareFoundation/Imath | 2026-06-13 | 3.2.2 via vcpkg baseline `3909e67a639d426ea939d9bff77bfe1d10443476` | Academy Software Foundation and Imath contributors | BSD-3-Clause | No first-party modifications | Optional `asset-importers` build output through OpenEXR |
| libdeflate | https://github.com/ebiggers/libdeflate | 2026-06-13 | 1.25 via vcpkg baseline `3909e67a639d426ea939d9bff77bfe1d10443476` | Eric Biggers and libdeflate contributors | MIT | No first-party modifications | Optional `asset-importers` build output through OpenEXR |
| OpenJPH | https://github.com/aous72/OpenJPH | 2026-06-16 | 0.27.0 via vcpkg baseline `3909e67a639d426ea939d9bff77bfe1d10443476` | OpenJPH contributors | BSD-2-Clause | No first-party modifications; vcpkg applies packaging patches | Optional `asset-importers` build output through OpenEXR |
...
| Microsoft DirectStorage SDK | https://www.nuget.org/packages/Microsoft.Direct3D.DirectStorage/1.3.0 | 2026-06-21 | 1.3.0 via vcpkg port `dstorage` at baseline `3909e67a639d426ea939d9bff77bfe1d10443476` | Microsoft Corporation | MIT for `native/include/` via `LICENSE-CODE.txt`; `LicenseRef-Microsoft-DirectStorage-SDK` for redistributable binaries via `LICENSE.txt` | No first-party modifications | Optional Windows-only `directstorage-win32` private adapter dependency for `MK_platform_win32`; SDK types and native handles stay out of public gameplay/runtime APIs |
