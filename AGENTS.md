...
- Use subagents in `.codex/agents/` and `.claude/agents/` only when the user explicitly asks for delegation or parallel work; keep roles scoped and close stale completed agents before spawning replacements near tool limits.
