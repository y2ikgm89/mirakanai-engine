...
- Use subagents in `.codex/agents/` and `.claude/agents/` only when explicitly asked; keep roles scoped, close completed/obsolete/no-longer-needed agents before replacements near tool limits, and leave useful work running.
