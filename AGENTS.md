...
- Treat a plan file as a coherent **behavior/API/validation boundary**, not a 2-5 minute task list. Keep steps inside the active plan; do not create new dated plans for validation-only follow-up, docs/manifest/static-check sync, small cleanup, or substeps.
