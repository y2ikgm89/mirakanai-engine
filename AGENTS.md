...
- Sample games are usually headless; active desktop runtime package samples use the first-party Win32 host. Legacy SDL3 sample sources are migration-only until deleted or ported. Use `mirakana_editor` for broader visible editor smoke.
