...
- Use `tools/new-game.ps1` plus `tools/new-game-helpers.ps1` for scaffolding, and register games with `MK_add_game` or `MK_add_desktop_runtime_game` in `games/CMakeLists.txt`.
