...
void mesh_main(in payload Payload payload_in,
    ...
    const float green = payload_in.color_index == 0 ? 1.0 : 0.5;
    ...
    vertices_out[0].color = float4(0.0, green, 0.0, 1.0);
    vertices_out[1].color = float4(0.0, green, 0.0, 1.0);
    vertices_out[2].color = float4(0.0, green, 0.0, 1.0);
