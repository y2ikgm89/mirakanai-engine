...
[[nodiscard]] bool has_matched_change(const mirakana::runtime::RuntimePackageHotReloadCandidateReviewRow& row,
...
MK_TEST("runtime package hot reload candidate review maps package index paths in stable order") {
    const auto result = mirakana::runtime::plan_runtime_package_hot_reload_candidate_review(
        mirakana::runtime::RuntimePackageHotReloadCandidateReviewDesc{
    ...
    MK_REQUIRE(result.status == mirakana::runtime::RuntimePackageHotReloadCandidateReviewStatus::review_ready);
...
MK_TEST("runtime package hot reload candidate review ignores invalid candidate rows before review") {
    ...
    MK_REQUIRE(!result.succeeded());
    MK_REQUIRE(result.status == mirakana::runtime::RuntimePackageHotReloadCandidateReviewStatus::no_matches);
...
MK_TEST("runtime package hot reload candidate review returns typed no-match statuses without package reads") {
    const auto no_changes = mirakana::runtime::plan_runtime_package_hot_reload_candidate_review(
        mirakana::runtime::RuntimePackageHotReloadCandidateReviewDesc{
            .changed_paths = {},
            .candidates =
                {
    ...
    const auto no_candidates = mirakana::runtime::plan_runtime_package_hot_reload_candidate_review(
        mirakana::runtime::RuntimePackageHotReloadCandidateReviewDesc{
            .changed_paths = {"runtime/packages/characters.geindex"},
            .candidates = {},
        });
    const auto no_matches = mirakana::runtime::plan_runtime_package_hot_reload_candidate_review(
        mirakana::runtime::RuntimePackageHotReloadCandidateReviewDesc{
    ...
    MK_REQUIRE(no_changes.status == mirakana::runtime::RuntimePackageHotReloadCandidateReviewStatus::no_changes);
    ...
    MK_REQUIRE(no_candidates.status == mirakana::runtime::RuntimePackageHotReloadCandidateReviewStatus::no_candidates);
    ...
    MK_REQUIRE(no_matches.status == mirakana::runtime::RuntimePackageHotReloadCandidateReviewStatus::no_matches);
