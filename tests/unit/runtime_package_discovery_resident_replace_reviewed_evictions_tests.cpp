...
[[nodiscard]] mirakana::runtime::RuntimePackageDiscoveryResidentReplaceReviewedEvictionsDesc
make_desc(mirakana::runtime::RuntimeResidentPackageMountId mount_id, std::string selected_package_index_path,
    ...
    return mirakana::runtime::RuntimePackageDiscoveryResidentReplaceReviewedEvictionsDesc{
        .discovery =
...
MK_TEST(
    ...
    const auto result = mirakana::runtime::commit_runtime_package_discovery_resident_replace_with_reviewed_evictions(
        filesystem, mount_set, catalog_cache,
        make_desc(mirakana::runtime::RuntimeResidentPackageMountId{.value = 1}, "runtime/packages/replacement.geindex",
                  replacement_payload.size(), {mirakana::runtime::RuntimeResidentPackageMountId{.value = 4}}));

    MK_REQUIRE(result.succeeded());
    MK_REQUIRE(result.status ==
               mirakana::runtime::RuntimePackageDiscoveryResidentReplaceReviewedEvictionsStatus::committed);
...
MK_TEST("runtime package discovery resident replace with reviewed evictions rejects descriptors before scans") {
    ...
    const auto invalid_path =
        mirakana::runtime::commit_runtime_package_discovery_resident_replace_with_reviewed_evictions(
            filesystem, mount_set, catalog_cache,
            make_desc(mirakana::runtime::RuntimeResidentPackageMountId{.value = 4}, "runtime/../escape.geindex"));
    const auto invalid_mount =
        mirakana::runtime::commit_runtime_package_discovery_resident_replace_with_reviewed_evictions(
            filesystem, mount_set, catalog_cache,
            make_desc(mirakana::runtime::RuntimeResidentPackageMountId{}, "runtime/packages/replacement.geindex"));
    const auto missing_mount =
        mirakana::runtime::commit_runtime_package_discovery_resident_replace_with_reviewed_evictions(
            filesystem, mount_set, catalog_cache,
            make_desc(mirakana::runtime::RuntimeResidentPackageMountId{.value = 99},
                      "runtime/packages/replacement.geindex"));

    MK_REQUIRE(invalid_path.status ==
               mirakana::runtime::RuntimePackageDiscoveryResidentReplaceReviewedEvictionsStatus::invalid_descriptor);
    MK_REQUIRE(invalid_mount.status ==
               mirakana::runtime::RuntimePackageDiscoveryResidentReplaceReviewedEvictionsStatus::invalid_mount_id);
    MK_REQUIRE(missing_mount.status ==
               mirakana::runtime::RuntimePackageDiscoveryResidentReplaceReviewedEvictionsStatus::missing_mount_id);
...
MK_TEST("runtime package discovery resident replace with reviewed evictions reports missing candidate before package "
    ...
    const auto result = mirakana::runtime::commit_runtime_package_discovery_resident_replace_with_reviewed_evictions(
        filesystem, mount_set, catalog_cache,
        make_desc(mirakana::runtime::RuntimeResidentPackageMountId{.value = 1}, "runtime/packages/missing.geindex"));

    MK_REQUIRE(result.status ==
               mirakana::runtime::RuntimePackageDiscoveryResidentReplaceReviewedEvictionsStatus::candidate_not_found);
    MK_REQUIRE(result.discovery.status == mirakana::runtime::RuntimePackageIndexDiscoveryStatus::discovered);
...
MK_TEST("runtime package discovery resident replace with reviewed evictions preserves state on discovery failures") {
    ...
    const auto invalid = mirakana::runtime::commit_runtime_package_discovery_resident_replace_with_reviewed_evictions(
        filesystem, mount_set, catalog_cache, invalid_desc);

    filesystem.fail_list_files(true);
    const auto scan = mirakana::runtime::commit_runtime_package_discovery_resident_replace_with_reviewed_evictions(
        filesystem, mount_set, catalog_cache,
        make_desc(mirakana::runtime::RuntimeResidentPackageMountId{.value = 1},
                  "runtime/packages/replacement.geindex"));
    ...
    MK_REQUIRE(scan.status ==
               mirakana::runtime::RuntimePackageDiscoveryResidentReplaceReviewedEvictionsStatus::discovery_failed);
...
MK_TEST(
    ...
    const auto result = mirakana::runtime::commit_runtime_package_discovery_resident_replace_with_reviewed_evictions(
        filesystem, mount_set, catalog_cache,
        make_desc(mirakana::runtime::RuntimeResidentPackageMountId{.value = 1}, "runtime/packages/broken.geindex"));

    MK_REQUIRE(result.status ==
               mirakana::runtime::RuntimePackageDiscoveryResidentReplaceReviewedEvictionsStatus::candidate_load_failed);
    MK_REQUIRE(result.candidate_resident_replace.status ==
...
MK_TEST("runtime package discovery resident replace with reviewed evictions rejects duplicate-asset indexes before "
    ...
    const auto result = mirakana::runtime::commit_runtime_package_discovery_resident_replace_with_reviewed_evictions(
        filesystem, mount_set, catalog_cache,
        make_desc(mirakana::runtime::RuntimeResidentPackageMountId{.value = 1}, "runtime/packages/duplicate.geindex"));
    ...
    MK_REQUIRE(
        ...
        mirakana::runtime::RuntimePackageDiscoveryResidentReplaceReviewedEvictionsDiagnosticPhase::candidate_load);
    MK_REQUIRE(result.diagnostics[0].asset == mirakana::AssetId{});
    MK_REQUIRE(result.diagnostics[0].mount == mirakana::runtime::RuntimeResidentPackageMountId{.value = 1});
    MK_REQUIRE(result.diagnostics[0].code == "package-index-invalid");
...
MK_TEST("runtime package discovery resident replace with reviewed evictions maps reviewed eviction failures") {
    ...
    const auto invalid = mirakana::runtime::commit_runtime_package_discovery_resident_replace_with_reviewed_evictions(
        filesystem, mount_set, catalog_cache,
        make_desc(mirakana::runtime::RuntimeResidentPackageMountId{.value = 1}, "runtime/packages/replacement.geindex",
                  3, {mirakana::runtime::RuntimeResidentPackageMountId{}}));
    const auto duplicate = mirakana::runtime::commit_runtime_package_discovery_resident_replace_with_reviewed_evictions(
        filesystem, mount_set, catalog_cache,
        make_desc(mirakana::runtime::RuntimeResidentPackageMountId{.value = 1}, "runtime/packages/replacement.geindex",
                  3,
                  {mirakana::runtime::RuntimeResidentPackageMountId{.value = 4},
                   mirakana::runtime::RuntimeResidentPackageMountId{.value = 4}}));
    const auto missing = mirakana::runtime::commit_runtime_package_discovery_resident_replace_with_reviewed_evictions(
        filesystem, mount_set, catalog_cache,
        make_desc(mirakana::runtime::RuntimeResidentPackageMountId{.value = 1}, "runtime/packages/replacement.geindex",
                  3, {mirakana::runtime::RuntimeResidentPackageMountId{.value = 99}}));
    ...
    MK_REQUIRE(invalid.status == mirakana::runtime::RuntimePackageDiscoveryResidentReplaceReviewedEvictionsStatus::
                                     invalid_eviction_candidate_mount_id);
    MK_REQUIRE(duplicate.status == mirakana::runtime::RuntimePackageDiscoveryResidentReplaceReviewedEvictionsStatus::
                                       duplicate_eviction_candidate_mount_id);
    MK_REQUIRE(missing.status == mirakana::runtime::RuntimePackageDiscoveryResidentReplaceReviewedEvictionsStatus::
                                     missing_eviction_candidate_mount_id);
    MK_REQUIRE(protected_mount.status ==
               mirakana::runtime::RuntimePackageDiscoveryResidentReplaceReviewedEvictionsStatus::
                   protected_eviction_candidate_mount_id);
    MK_REQUIRE(
        invalid.diagnostics[0].phase ==
        mirakana::runtime::RuntimePackageDiscoveryResidentReplaceReviewedEvictionsDiagnosticPhase::eviction_plan);
...
MK_TEST("runtime package discovery resident replace with reviewed evictions preserves state when candidates are "
    ...
    const auto result = mirakana::runtime::commit_runtime_package_discovery_resident_replace_with_reviewed_evictions(
        filesystem, mount_set, catalog_cache,
        make_desc(mirakana::runtime::RuntimeResidentPackageMountId{.value = 1}, "runtime/packages/replacement.geindex",
                  4, {mirakana::runtime::RuntimeResidentPackageMountId{.value = 4}}));
