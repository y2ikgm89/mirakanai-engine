...
$editorCrossPlatformAdapterGateChecks = @(
    ...
    @{ Path = "docs/dependencies.md"; Needles = @("HarfBuzz, FreeType, Fontconfig, ICU", "license-audit", "vcpkg.json", "THIRD_PARTY_NOTICES.md") },
    @{ Path = "docs/legal-and-licensing.md"; Needles = @("HarfBuzz, FreeType, Fontconfig, ICU", "legal/dependency-gated", "license-audit", "THIRD_PARTY_NOTICES.md") },
