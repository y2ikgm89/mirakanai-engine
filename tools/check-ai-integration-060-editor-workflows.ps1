...
$nativeEditorUiPerformanceBudgetChecks = @(
    ...
    @{ Path = "editor/core/include/mirakana/editor/editor_dock_layout.hpp"; Needles = @("EditorDockMultiWindowLayout", "EditorDockWindowCommandRequest", "EditorDockWindowCommandPlan", "plan_editor_dock_window_command", "apply_editor_dock_window_command") },
    @{ Path = "editor/core/include/mirakana/editor/workspace.hpp"; Needles = @("multi_window_dock_layout", "serialize_workspace_v3", "deserialize_workspace_v3") },
    @{ Path = "editor/core/src/ai_operation_surface.cpp"; Needles = @("editor.dock.window.create", "editor.dock.window.close", "editor.dock.panel.tear_off", "editor.dock.panel.move_to_window", "editor.dock.window.merge", "editor.dock.window.reset_all", "editor.ai.dock.workspace_v3") },
    @{ Path = "editor/src/main.cpp"; Needles = @("editor_shell_multi_window_docking_status=", "editor_shell_dock_windows=", "editor_shell_workspace_v3_status=", "editor_shell_multi_window_native_handles_exposed=") },
    @{ Path = "CMakeLists.txt"; Needles = @("editor_shell_multi_window_docking_status=ready", "editor_shell_dock_windows=1", "editor_shell_dock_tear_off_commands=1", "editor_shell_dock_window_merge_commands=1", "editor_shell_workspace_v3_status=ready", "editor_shell_multi_window_native_handles_exposed=0") },
    @{ Path = "tests/unit/editor_core_tests.cpp"; Needles = @("editor workspace v3 persists multi window dock roots monitor dpi and focused rows", "editor core multi window dock commands tear off move merge close and reset", "editor ai command catalog exposes multi window dock commands") },
    @{ Path = "tests/unit/editor_native_shell_tests.cpp"; Needles = @("editor first party shell smoke counters report imgui disabled and multi window dock workspace rows", "multi_window_docking_status", "workspace_v3_status", "multi_window_native_handles_exposed") }
)
