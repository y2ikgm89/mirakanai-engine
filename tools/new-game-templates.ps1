...
- selected generated 3D renderer quality smoke over scene GPU, depth-aware postprocess, framegraph_passes=2, framegraph_passes_executed=4, framegraph_barrier_steps_executed=6, and renderer_quality_expected_framegraph_barrier_steps=6
