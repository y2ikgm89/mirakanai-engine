...
- selected generated 3D renderer quality smoke over scene GPU, depth-aware postprocess, framegraph_passes=2, framegraph_passes_executed=4, framegraph_barrier_steps_executed=9, and renderer_quality_expected_framegraph_barrier_steps=9
...
- selected generated 3D directional shadow package smoke with `directional_shadow_ready=1`, fixed PCF 3x3 filtering counters, `framegraph_passes=3`, `framegraph_passes_executed=6`, and `framegraph_barrier_steps_executed=15`
