...
- selected generated 3D gameplay systems package smoke with `gameplay_systems_status=ready`, `gameplay_systems_ready=1`, physics authored collision/controller counters, navmesh dynamic-obstacle/readiness counters, deterministic navmesh/crowd counters, local avoidance counters, character/dynamic physics policy counters, character dynamics readiness counters, kinematic/simple vehicle policy counters, navigation, AI perception/behavior, audio stream, and animation/lifecycle counters
