...
if ($null -eq $sample3dManifestEntry) {
    ...
    foreach ($needle in @(
        ...
        "--require-environment-texture-asset-pipeline-package", "environment_texture_asset_pipeline_package_status=ready", "environment_texture_asset_pipeline_upload_plan_ready_records=1", "environment_texture_asset_pipeline_upload_plan_gpu_upload_invoked=0", "desktop-runtime-sample-game-environment-vulkan-strict-aggregate", "--require-environment-vulkan-strict-aggregate", "environment_vulkan_strict_aggregate_status=ready", "environment_vulkan_strict_aggregate_descriptor_set_bindings=15",
        ...
        "zero upload-plan backend/GPU/runtime codec side effects, GPU upload, or broad asset-pipeline ready counters",
