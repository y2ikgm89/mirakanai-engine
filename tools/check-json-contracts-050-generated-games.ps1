...
if ($null -eq $sample3dManifestEntry) {
    ...
    foreach ($needle in @(
        ...
        "--require-environment-texture-asset-pipeline-package", "--require-environment-preset-library-package", "--require-environment-vulkan-strict-aggregate", "--require-environment-platform-readiness", "--require-environment-optimization-measurement",
