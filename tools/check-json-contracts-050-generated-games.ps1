...
if ($null -eq $sample3dManifestEntry) {
    ...
    foreach ($needle in @(
        ...
        "--require-job-execution-foundation", "job_execution_foundation_status=ready", "job_execution_foundation_worker_threads_started=2", "job_execution_foundation_task_side_effects=3",
    ...
    foreach ($needle in @(
        ...
        "job_execution_foundation_status=", "job_execution_foundation_ready=", "job_execution_foundation_worker_threads_started=", "job_execution_foundation_tasks_submitted=", "job_execution_foundation_tasks_executed=", "job_execution_foundation_task_side_effects=", "job_execution_foundation_deterministic_merges=",
    ...
    foreach ($needle in @("--require-job-scheduling-evidence", "--require-job-execution-foundation", "sample_desktop_runtime_game")) { if (-not $sample3dCMakeText.Contains($needle)) { Write-Error "games/CMakeLists.txt missing sample_desktop_runtime_game job scheduling/execution smoke evidence: $needle" } }
