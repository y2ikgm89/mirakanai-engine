...
if ($null -eq $sample3dManifestEntry) {
    ...
    foreach ($needle in @(
        ...
        "--require-environment-texture-asset-pipeline-package", "environment_texture_asset_pipeline_package_status=ready",
    ...
    foreach ($needle in @(
        ...
        "--require-environment-texture-asset-pipeline-package", "--require-environment-preset-library-package",
