...
if ($null -eq $sample3dManifestEntry) {
    ...
    foreach ($needle in @(
        ...
        "--require-environment-texture-asset-pipeline-package", "--require-environment-texture-asset-pipeline-d3d12-upload", "--require-environment-texture-asset-pipeline-vulkan-upload", "--require-environment-preset-library-package", "--require-environment-vulkan-strict-aggregate", "--require-environment-platform-readiness", "--require-environment-platform-windows-vulkan-evidence", "--require-environment-optimization-measurement", "--require-environment-weather-simulation-package",
