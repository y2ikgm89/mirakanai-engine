...
if ($null -eq $sample2dDesktopManifestEntry) {
    ...
    foreach ($needle in @(
        ...
        "installed-native-2d-sprite-smoke", "--require-d3d12-shaders", "--require-d3d12-renderer", "--require-vulkan-shaders", "--require-vulkan-renderer",
        "--require-native-2d-sprites", "--require-gameplay-systems", "--require-world-region-streaming", "--require-entity-scale-culling",
        "--require-scripting-sandbox-policy", "--require-networking-foundation-policy", "--require-simulation-orchestration", "--require-runtime-ui-renderer-atlas-handoff",
        "gameplay systems package proof", "Runtime UI renderer atlas handoff smoke", "world-region streaming package proof", "entity scale/culling package proof", "scripting sandbox policy proof", "networking foundation policy proof", "simulation orchestration package proof",
        ...
        "inputDeviceProductionUx2D", "2d_input_device_production_ux_status=ready",
        ...
        "installed-2d-entity-scale-culling-smoke", "installed-2d-scripting-sandbox-policy-smoke", "installed-2d-networking-foundation-policy-smoke",
        "installed-2d-simulation-orchestration-smoke", "installed-2d-input-device-production-ux-smoke", "installed-2d-long-run-readiness-smoke",
    ...
    foreach ($needle in @(
        ...
        "--require-d3d12-shaders", "--require-d3d12-renderer", "--require-vulkan-shaders", "--require-vulkan-renderer",
        "--require-native-2d-sprites", "--require-gameplay-systems", "--require-world-region-streaming", "--require-scripting-sandbox-policy",
        "--require-networking-foundation-policy", "--require-simulation-orchestration", "--require-2d-input-device-production-ux", "--require-long-run-performance-readiness",
        ...
        "2d_input_device_production_ux_status=", "2d_input_device_production_ux_gesture_binding_rows=", "2d_input_device_production_ux_device_assignment_rows=", "2d_input_device_production_ux_per_device_profile_rows=",
        "2d_input_device_production_ux_glyph_asset_lookup_rows=", "2d_input_device_production_ux_keyboard_layout_label_rows=", "2d_input_device_production_ux_native_handle_access_rows=", "2d_input_device_production_ux_input_middleware_rows=",
        ...
        "required_long_run_performance_readiness_unavailable", "required_gameplay_authoring_review_unavailable", "required_simulation_orchestration_unavailable",
        "required_networking_foundation_policy_unavailable", "required_scripting_sandbox_policy_unavailable", "required_entity_scale_culling_unavailable",
        "required_2d_input_device_production_ux_unavailable", "required_world_region_streaming_unavailable", "required_gameplay_systems_unavailable",
    ...
    foreach ($needle in @(
        ...
        "sample_2d_desktop_runtime_package_native_sprite_overlay.ps.spv",
        "--require-native-2d-sprites", "--require-gameplay-systems", "--require-world-region-streaming", "--require-entity-scale-culling",
        "--require-scripting-sandbox-policy", "--require-networking-foundation-policy", "--require-simulation-orchestration", "--require-2d-input-device-production-ux", "--require-gameplay-authoring-review",
        "MK_ai",
        "MK_navigation",
        "MK_physics",
    ...
    foreach ($needle in @(
        "--require-native-2d-sprites", "--require-world-region-streaming", "--require-entity-scale-culling", "--require-scripting-sandbox-policy",
        "--require-networking-foundation-policy", "--require-simulation-orchestration", "--require-2d-input-device-production-ux", "--require-gameplay-authoring-review", "--require-long-run-performance-readiness",
