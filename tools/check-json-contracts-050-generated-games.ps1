...
if ($null -eq $sample3dManifestEntry) {
    ...
    foreach ($needle in @(
        ...
        "zero upload-plan backend/GPU/runtime codec side effects, Apple-host Metal upload parity, backend-target compressed payload execution, or broad asset-pipeline ready counters",
