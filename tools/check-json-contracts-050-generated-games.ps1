...
if ($null -eq $sample3dManifestEntry) {
    ...
    foreach ($needle in @(
        ...
        "zero upload-plan backend/GPU/runtime codec side effects, strict Vulkan/Metal upload parity, backend-target compressed payload execution, or broad asset-pipeline ready counters",
    ...
    foreach ($needle in @(
        ...
        "--require-environment-texture-asset-pipeline-package", "--require-environment-texture-asset-pipeline-d3d12-upload", "--require-environment-preset-library-package", "--require-environment-vulkan-strict-aggregate", "--require-environment-platform-readiness", "--require-environment-optimization-measurement", "--require-environment-weather-simulation-package",
