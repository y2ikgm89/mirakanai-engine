...
foreach ($needle in @("MAVG D3D12 Indexed Indirect Draw Execution v1", "PR #539", "D3D12 ExecuteIndirect", "count-buffer execution", "mavg-vulkan-indexed-indirect-draw-execution-v1", "unsupportedProductionGaps = []")) {
