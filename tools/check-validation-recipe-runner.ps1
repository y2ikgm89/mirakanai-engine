...
Assert-DryRunRecipe -Recipe "renderer-commercial-readiness-final-run-discovery" -ExpectedArgv @("-File", "plan-renderer-commercial-readiness-final-run-discovery.ps1", "-Mode", "Plan") | Out-Null
