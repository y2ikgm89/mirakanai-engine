...
foreach ($needle in @(
    ...
    "Inspector property rows with visible edit command controls only for editable rich-text documents",
    "EditorRichTextEditCommandKind",
    "EditorRichTextEditRequest",
    "EditorRichTextEditResult",
    "EditorRichTextClipboardPayload",
    "editor_rich_text_revision",
    "normalize_editor_rich_text_selection",
    "apply_editor_rich_text_edit_command",
    ...
    "host/toolchain-gated Vulkan counter surface",
