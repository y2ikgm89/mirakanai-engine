...
foreach ($sourceSurface in @(
        ...
        @{ Path = "tools/package-linux-runtime.ps1"; Needles = @("Get-VcpkgDefaultTriplet", "`$vcpkgTriplet", "-DVCPKG_TARGET_TRIPLET=`$vcpkgTriplet", "desktop-runtime-release", "validate-installed-linux-runtime.ps1") },
