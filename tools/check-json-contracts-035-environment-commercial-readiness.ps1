...
foreach ($needle in @("EnvironmentWeatherSimulationDesc", "EnvironmentWeatherSimulationCellState", "EnvironmentWeatherSimulationCellForcing", "EnvironmentWeatherSimulationPlan", "EnvironmentWeatherSimulationSolverBudgetDesc", "EnvironmentWeatherSimulationSolverBudgetPlan", "EnvironmentWeatherSimulationValidationDatasetDesc", "EnvironmentWeatherSimulationValidationDatasetPlan", "plan_environment_weather_simulation_validation_dataset", "environment_weather_saturation_vapor_kg_per_m2", "simulate_environment_weather_cpu_reference", "plan_environment_weather_simulation_solver_budget", "MK_environment_weather_simulation_tests", "NWS vapor-pressure formula", "effective_timestep_s", "water", "deterministic replay hash", "validation dataset hashes", "desktop-runtime-sample-game-environment-weather-simulation-package", "--require-environment-weather-simulation-package", "environment_weather_simulation_package_ready=1", "environment_weather_simulation_steps=1", "environment_weather_simulation_solver_budget_status=host_evidence_required", "environment_weather_simulation_cpu_reference_solver_ready=1", "environment_weather_simulation_production_solver_ready=0", "environment_weather_simulation_validation_dataset_status=ready", "environment_weather_simulation_validation_dataset_ready=1", "environment_weather_simulation_validation_images_ready=0", "environment_physical_weather_simulation_ready=0", "GPU acceleration", "backend execution", "native handle access", "environment_physical_weather_simulation_ready=1 may be inferred")) {
