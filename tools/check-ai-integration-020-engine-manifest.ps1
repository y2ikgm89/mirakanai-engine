...
Assert-ContainsText $masterPlanText "recommendedNextPlan.id = mavg-win32-directstorage-sdk-adapter-v1" "production master plan MAVG Win32 DirectStorage SDK adapter pointer"
