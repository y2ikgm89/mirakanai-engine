...
$recommendedText = (([string]$productionLoop.recommendedNextPlan.activeSelectionEvidence), ([string]$productionLoop.recommendedNextPlan.latestCloseoutEvidence), ([string]$productionLoop.recommendedNextPlan.completedContext), ([string]$productionLoop.recommendedNextPlan.reason), ([string]$productionLoop.recommendedNextPlan.phase5LocalEvidence), ([string]$productionLoop.recommendedNextPlan.phase6LocalEvidence)) -join " "
