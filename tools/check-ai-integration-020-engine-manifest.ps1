...
Assert-ContainsText $masterPlanText "recommendedNextPlan.id = ai-operable-performance-budget-and-evidence-v1" "production master plan active performance budget pointer"
