...
Assert-ContainsText $masterPlanText "recommendedNextPlan.id = job-scheduling-evidence-v1" "production master plan active job scheduling evidence pointer"
