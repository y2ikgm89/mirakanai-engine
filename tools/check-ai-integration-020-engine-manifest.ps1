...
Assert-ContainsText $masterPlanText "recommendedNextPlan.id = renderer-backend-parity-apple-evidence-closeout-v1" "production master plan active renderer backend parity Apple evidence pointer"
