...
Assert-ContainsText $masterPlanText "recommendedNextPlan.id = memory-lifetime-taxonomy-v1" "production master plan active memory lifetime taxonomy pointer"
