...
foreach ($check in @(
    @{
        ...
        Needles = @(
            ...
            "RuntimeResidentPackageMountId",
            "RuntimeResidentPackageMountStatus",
            "RuntimeResidentPackageMountCatalogBuildResult",
            "build_runtime_resource_catalog_from_resident_mount_set",
            "RuntimeResidentCatalogCache",
            "RuntimeResidentCatalogCacheStatus",
            "RuntimeResidentPackageReplaceCommitStatus",
            "RuntimeResidentPackageReplaceCommitResult",
            "commit_runtime_resident_package_replace",
            "RuntimeResidentPackageUnmountCommitStatus",
            "RuntimeResidentPackageUnmountCommitResult",
            "commit_runtime_resident_package_unmount",
            "RuntimeResidentPackageEvictionPlanStatus",
            "RuntimeResidentPackageEvictionPlanDesc",
            "RuntimeResidentPackageEvictionPlanResult",
            "plan_runtime_resident_package_evictions",
            "RuntimeResidentPackageReviewedEvictionCommitStatus",
            "RuntimeResidentPackageReviewedEvictionCommitDesc",
            "RuntimeResidentPackageReviewedEvictionCommitResult",
            "commit_runtime_resident_package_reviewed_evictions",
            "RuntimePackageDiscoveryResidentReplaceReviewedEvictionsStatus",
            "RuntimePackageDiscoveryResidentReplaceReviewedEvictionsDesc",
            ...
            "RuntimePackageHotReloadCandidateReviewStatus",
            "RuntimePackageHotReloadCandidateReviewDesc",
            "RuntimePackageHotReloadCandidateReviewResult",
            "plan_runtime_package_hot_reload_candidate_review",
            "RuntimePackageHotReloadRecookChangeReviewStatus",
            "RuntimePackageHotReloadRecookChangeReviewDesc",
            "RuntimePackageHotReloadRecookChangeReviewResult",
            "plan_runtime_package_hot_reload_recook_change_review",
            "RuntimePackageHotReloadReplacementIntentReviewStatus",
            "invalid_overlay",
            "RuntimePackageHotReloadReplacementIntentReviewDesc",
            "RuntimePackageHotReloadReplacementIntentReviewResult",
            "plan_runtime_package_hot_reload_replacement_intent_review",
            "RuntimePackageHotReloadRecookReplacementStatus",
            "RuntimePackageHotReloadRecookReplacementDesc",
    ...
    @{
        ...
        Needles = @(
            "RuntimeResidentPackageReplaceCommitResult::succeeded",
            "RuntimeResidentPackageEvictionPlanResult::succeeded",
            "RuntimeResidentPackageReviewedEvictionCommitResult::succeeded",
            "RuntimePackageDiscoveryResidentReplaceReviewedEvictionsResult::succeeded",
            "RuntimePackageHotReloadCandidateReviewResult::succeeded",
            "RuntimePackageHotReloadRecookChangeReviewResult::succeeded",
            "RuntimePackageHotReloadReplacementIntentReviewResult::succeeded",
            "RuntimePackageHotReloadRecookReplacementResult::succeeded",
            "plan_runtime_package_hot_reload_candidate_review",
            "plan_runtime_package_hot_reload_recook_change_review",
            "plan_runtime_package_hot_reload_replacement_intent_review",
            "commit_runtime_package_hot_reload_recook_replacement",
            "map_hot_reload_recook_replacement_commit_diagnostic_phase",
            "RuntimePackageHotReloadRecookReplacementDiagnosticPhase::candidate_load",
            "RuntimePackageHotReloadRecookReplacementDiagnosticPhase::resident_budget",
            ...
            "RuntimeResidentPackageMountSetReplaceAccess",
