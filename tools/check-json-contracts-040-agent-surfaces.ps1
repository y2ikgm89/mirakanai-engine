...
if ([string]$productionLoop.recommendedNextPlan.id -ne "general-purpose-game-production-v1") {
    ...
    } elseif ([string]$productionLoop.recommendedNextPlan.id -eq "mavg-payload-byte-range-file-io-v1") { foreach ($needle in @("MAVG Payload Byte-Range File IO v1", "MAVG Runtime LOD Milestone v1", "IFileSystem read_bytes", "write_bytes", "read_byte_range", "RuntimeMavgPayloadPageFileLoadResult", "load_runtime_mavg_payload_file_pages", "invoked_file_io=true", "used_native_directstorage=false", "native DirectStorage queues/fences/status arrays", "async-overlap/performance", "Nanite compatibility/equivalence/superiority", "unsupportedProductionGaps = []")) { Assert-ContainsText $recommendedText $needle "engine manifest aiOperableProductionLoop recommendedNextPlan MAVG byte-range file IO selection" }
} elseif ([string]$productionLoop.recommendedNextPlan.id -eq "mavg-runtime-lod-milestone-v1" -or [string]$productionLoop.recommendedNextPlan.id -eq "mavg-package-streaming-residency-dispatch-v1" -or [string]$productionLoop.recommendedNextPlan.id -eq "mavg-page-addressable-payload-schema-v1" -or [string]$productionLoop.recommendedNextPlan.id -eq "mavg-directstorage-request-plan-v1" -or [string]$productionLoop.recommendedNextPlan.id -eq "mavg-native-directstorage-win32-async-io-dispatch-status-v1" -or [string]$productionLoop.recommendedNextPlan.id -eq "mavg-win32-async-file-io-adapter-v1" -or [string]$productionLoop.recommendedNextPlan.id -eq "mavg-win32-iocp-file-io-worker-v1" -or [string]$productionLoop.recommendedNextPlan.id -eq "mavg-directstorage-sdk-dependency-gate-v1" -or [string]$productionLoop.recommendedNextPlan.id -eq "mavg-autonomous-page-streaming-worker-v1" -or [string]$productionLoop.recommendedNextPlan.id -eq "mavg-automatic-eviction-policy-v1" -or [string]$productionLoop.recommendedNextPlan.id -eq "mavg-resident-page-recency-eviction-order-v1" -or [string]$productionLoop.recommendedNextPlan.id -eq "mavg-runtime-inferred-page-use-generation-v1" -or [string]$productionLoop.recommendedNextPlan.id -eq "mavg-runtime-inferred-lru-eviction-policy-v1" -or [string]$productionLoop.recommendedNextPlan.id -eq "mavg-runtime-inferred-frequency-eviction-policy-v1" -or [string]$productionLoop.recommendedNextPlan.id -eq "mavg-gpu-memory-pressure-eviction-policy-v1") { foreach ($needle in @("MAVG Runtime LOD Milestone v1", "MAVG Asset Graph v1", "MAVG Phase 0 completed", "hierarchy/error/fallback", "MavgClusterGraphCluster", "resident_fallback_cluster_index", "geometric_error", "first_index", "index_count", "vertex_base", "GameEngine.MavgClusterGraph.v1", "MavgClusterCookVertex", "GameEngine.MavgClusterPayload.v1", "vertex.data_hex", "index.data_hex", "page.data_hex", "per-material root/leaf", "mavg_cluster_payload.hpp", "MavgClusterPayloadDocument", "MavgClusterPayloadPage", "validate_mavg_cluster_payload", "mavg_payload_pages.hpp", "RuntimeMavgPayloadPageSliceResult", "extract_runtime_mavg_payload_page_slices", "mavg_lod_selection.hpp", "MavgLodViewDesc", "MavgLodResidentPageSet", "MavgLodSelectionResult", "CPU LOD selection", "select_mavg_lod_clusters", "MK_mavg_lod_selection_tests", "mavg_lod_residency.hpp", "RuntimeMavgLodResidencyDesc", "RuntimeMavgLodResidencyResult", "build_runtime_mavg_lod_residency", "MK_runtime_mavg_lod_residency_tests", "range-aware conventional indexed draws", "mavg_scene_lod.hpp", "MavgSceneLodSubmitDesc", "MavgSceneLodSubmitResult", "plan_mavg_scene_lod_mesh_commands", "MK_scene_renderer_mavg_lod_tests", "RuntimeMavgPageStreamingDispatchPlan", "plan_runtime_mavg_page_streaming_dispatches", "RuntimeMavgPageStreamingDrainDesc", "RuntimeMavgPageStreamingAutomaticEvictionPlanDesc", "plan_runtime_mavg_page_streaming_automatic_evictions", "RuntimeMavgPageStreamingRecencyRow", "caller_supplied_recency", "resident_page_last_used_generation", "recency_eviction_candidate_count", "RuntimeMavgResidentPageUseGenerationDesc", "RuntimeMavgResidentPageUseGenerationResult", "infer_runtime_mavg_resident_page_use_generations", "inferred_resident_page_use_generation", "non_monotonic_use_generation", "runtime_inferred_lru", "inferred_lru_eviction_policy", "runtime_inferred_lru_eviction_candidate_count", "runtime_inferred_frequency", "RuntimeMavgPageStreamingFrequencyRow", "infer_runtime_mavg_resident_page_frequencies", "inferred_frequency_eviction_policy", "runtime_inferred_frequency_eviction_candidate_count", "frequency_counter_overflow", "caller_supplied_gpu_memory_pressure", "RuntimeMavgPageStreamingGpuMemoryPressureRow", "gpu_memory_pressure_eviction_candidate_count", "gpu_memory_pressure_counter_overflow", "GPU culling", "indirect draw execution", "mesh shaders", "Nanite compatibility/equivalence/superiority", "unsupportedProductionGaps = []")) { Assert-ContainsText $recommendedText $needle "engine manifest aiOperableProductionLoop recommendedNextPlan MAVG runtime LOD selection" }
    ...
    } elseif ([string]$productionLoop.recommendedNextPlan.id -eq "mavg-payload-byte-range-file-io-v1") { foreach ($needle in @("MAVG Payload Byte-Range File IO v1", "IFileSystem read_bytes", "read_byte_range", "RuntimeMavgPayloadPageFileLoadResult", "load_runtime_mavg_payload_file_pages", "used_native_directstorage=false", "native DirectStorage queues/fences/status arrays", "Nanite compatibility/equivalence/superiority", "unsupportedProductionGaps = []")) { Assert-ContainsText $recommendedText $needle "engine manifest aiOperableProductionLoop recommendedNextPlan MAVG byte-range file IO selection" }
    } elseif ([string]$productionLoop.recommendedNextPlan.id -eq "mavg-runtime-lod-milestone-v1" -or [string]$productionLoop.recommendedNextPlan.id -eq "mavg-package-streaming-residency-dispatch-v1" -or [string]$productionLoop.recommendedNextPlan.id -eq "mavg-page-addressable-payload-schema-v1" -or [string]$productionLoop.recommendedNextPlan.id -eq "mavg-directstorage-request-plan-v1" -or [string]$productionLoop.recommendedNextPlan.id -eq "mavg-native-directstorage-win32-async-io-dispatch-status-v1" -or [string]$productionLoop.recommendedNextPlan.id -eq "mavg-win32-async-file-io-adapter-v1" -or [string]$productionLoop.recommendedNextPlan.id -eq "mavg-win32-iocp-file-io-worker-v1" -or [string]$productionLoop.recommendedNextPlan.id -eq "mavg-directstorage-sdk-dependency-gate-v1" -or [string]$productionLoop.recommendedNextPlan.id -eq "mavg-automatic-eviction-policy-v1" -or [string]$productionLoop.recommendedNextPlan.id -eq "mavg-resident-page-recency-eviction-order-v1" -or [string]$productionLoop.recommendedNextPlan.id -eq "mavg-runtime-inferred-page-use-generation-v1" -or [string]$productionLoop.recommendedNextPlan.id -eq "mavg-runtime-inferred-lru-eviction-policy-v1" -or [string]$productionLoop.recommendedNextPlan.id -eq "mavg-runtime-inferred-frequency-eviction-policy-v1" -or [string]$productionLoop.recommendedNextPlan.id -eq "mavg-gpu-memory-pressure-eviction-policy-v1") { foreach ($needle in @("MAVG Runtime LOD Milestone v1", "MAVG Asset Graph v1", "MAVG Phase 0 completed", "GameEngine.MavgClusterGraph.v1", "GameEngine.MavgClusterPayload.v1", "vertex.data_hex", "index.data_hex", "page.data_hex", "mavg_cluster_payload.hpp", "MavgClusterPayloadDocument", "MavgClusterPayloadPage", "validate_mavg_cluster_payload", "mavg_payload_pages.hpp", "RuntimeMavgPayloadPageSliceResult", "extract_runtime_mavg_payload_page_slices", "RuntimeMavgPageStreamingDispatchPlan", "plan_runtime_mavg_page_streaming_dispatches", "RuntimeMavgPageStreamingDrainDesc", "RuntimeMavgPageStreamingAutomaticEvictionPlanDesc", "plan_runtime_mavg_page_streaming_automatic_evictions", "RuntimeMavgPageStreamingRecencyRow", "caller_supplied_recency", "resident_page_last_used_generation", "recency_eviction_candidate_count", "RuntimeMavgResidentPageUseGenerationDesc", "RuntimeMavgResidentPageUseGenerationResult", "infer_runtime_mavg_resident_page_use_generations", "inferred_resident_page_use_generation", "non_monotonic_use_generation", "runtime_inferred_lru", "inferred_lru_eviction_policy", "runtime_inferred_lru_eviction_candidate_count", "runtime_inferred_frequency", "RuntimeMavgPageStreamingFrequencyRow", "infer_runtime_mavg_resident_page_frequencies", "inferred_frequency_eviction_policy", "runtime_inferred_frequency_eviction_candidate_count", "frequency_counter_overflow", "caller_supplied_gpu_memory_pressure", "RuntimeMavgPageStreamingGpuMemoryPressureRow", "gpu_memory_pressure_eviction_candidate_count", "gpu_memory_pressure_counter_overflow", "GPU culling", "indirect draw execution", "mesh shaders", "Nanite compatibility/equivalence/superiority", "unsupportedProductionGaps = []")) { Assert-ContainsText $recommendedText $needle "engine manifest aiOperableProductionLoop recommendedNextPlan MAVG runtime LOD selection" } } else {
        foreach ($needle in @(
    ...
    "3d-playable-vertical-slice"
        ...
        if ((-not $recommendedText.Contains($needle)) -and ([string]$productionLoop.recommendedNextPlan.id -notmatch '^mavg-(runtime-lod-milestone|package-streaming-residency-dispatch|page-addressable-payload-schema|payload-byte-range-file-io|directstorage-request-plan|native-directstorage-win32-async-io-dispatch-status|win32-async-file-io-adapter|win32-iocp-file-io-worker|directstorage-sdk-dependency-gate|autonomous-page-streaming-worker|automatic-eviction-policy|resident-page-recency-eviction-order|runtime-inferred-page-use-generation|runtime-inferred-lru-eviction-policy|runtime-inferred-frequency-eviction-policy)-v1$')) {
