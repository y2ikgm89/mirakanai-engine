...
foreach ($needle in @(
    ...
    "installed-2d-production-tile-renderer-smoke",
    ...
    "production tile renderer proof",
...
foreach ($needle in @(
    ...
    "mirakana/renderer/tile_chunk_renderer.hpp",
    ...
    "plan_tile_chunk_renderer",
    "build_tile_chunk_renderer_plan",
    "installed-2d-production-authoring-workflows-smoke",
    "--require-native-2d-sprites",
    "--require-sprite-animation",
    "--require-tilemap-runtime-ux",
    ...
    "runtime_ui_workbench_status=", "runtime_ui_workbench_ready=", "runtime_ui_workbench_panels=",
    "runtime_ui_workbench_table_columns=", "runtime_ui_workbench_table_rows=", "runtime_ui_workbench_graph_series=",
    "runtime_ui_workbench_item_rows=", "runtime_ui_workbench_inventory_rows=", "runtime_ui_workbench_equipment_rows=",
    "runtime_ui_workbench_shop_rows=", "runtime_ui_workbench_text_inputs=", "runtime_ui_workbench_platform_text_input_requests=",
    "runtime_ui_workbench_focus_edges=", "runtime_ui_workbench_localization_refs=", "runtime_ui_workbench_localization_identity_ready=",
    "runtime_ui_workbench_accessibility_refs=", "runtime_ui_workbench_accessibility_identity_ready=", "runtime_ui_workbench_renderer_submission=",
    "runtime_ui_workbench_text_shaping=", "runtime_ui_workbench_font_rasterization=", "runtime_ui_workbench_ime_sessions=",
    "runtime_ui_workbench_accessibility_bridge=", "runtime_ui_workbench_image_decoding=", "runtime_ui_workbench_native_platform=",
    "runtime_ui_workbench_diagnostics=",
    "--require-runtime-ui-renderer-atlas-handoff",
    "UiRendererSubmission",
    "plan_ui_renderer_execution",
    ...
    "required_production_tile_renderer_unavailable"
)) {
...
foreach ($needle in @(
    ...
    "--require-environment-preset-library-package",
    "--require-environment-vulkan-strict-aggregate", "--require-environment-platform-readiness", "--require-environment-platform-windows-vulkan-evidence", "--require-environment-optimization-measurement",
    ...
    "environment_platform_windows_vulkan_ready=0", "environment_platform_windows_vulkan_evidence_requested=1", "environment_platform_windows_vulkan_strict_aggregate_ready=1",
    "environment_platform_windows_vulkan_ready=1", "environment_platform_requires_windows_vulkan_host_evidence=0", "environment_all_platform_unconditional_ready=0",
...
foreach ($sceneSchemaDoc in @(
    ...
    Assert-ContainsText $sceneSchemaDoc.Text "unsupported_local_prefab_component" $sceneSchemaDoc.Label
    Assert-ContainsText $sceneSchemaDoc.Text "contract-only" $sceneSchemaDoc.Label
