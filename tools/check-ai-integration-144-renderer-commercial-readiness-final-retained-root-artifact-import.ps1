...
foreach ($needle in @(
        ...
        "WorkflowRelative",
        "workflow_audit",
        "reviewed_workflow_file",
        "workflow_dispatch_only",
        "untrusted_pr_triggers_present",
        "contents_permission_read_only",
        "checkout_action_pinned",
        "checkout_persist_credentials_disabled",
        "confirm_input_required",
        "renderer_public_runner_security_review_workflow_audit_ready=",
...
foreach ($needle in @(
        ...
        "checkout_action_pinned",
        "checkout_persist_credentials_disabled",
        "renderer_commercial_readiness_final_handoff_runner_public_repo_security_review_artifact_workflow_audit_valid=",
        "renderer_commercial_readiness_final_handoff_runner_public_repo_registration_blocked=",
        "capableHostWorkflowCommandReady",
...
foreach ($needle in @(
        ...
        "final handoff run discovery ready public runner reviewed",
        "renderer_commercial_readiness_final_handoff_runner_label_truth_requires_metal_probe=1",
...
foreach ($needle in @(
        ...
        "runner_public_repo_security_review_artifact_workflow_audit_valid",
