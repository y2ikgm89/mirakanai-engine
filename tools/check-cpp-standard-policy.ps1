...
Assert-TextContains "CMakeLists.txt" 'MK_disable_module_scanning_for_non_module_executable' "root CMake"
Assert-TextContains "CMakeLists.txt" 'CXX_SCAN_FOR_MODULES OFF' "root CMake"
Assert-TextContains "CMakeLists.txt" 'BUILDSYSTEM_TARGETS' "root CMake"
Assert-TextContains "games/CMakeLists.txt" 'MK_disable_module_scanning_for_non_module_executable' "games CMake"
