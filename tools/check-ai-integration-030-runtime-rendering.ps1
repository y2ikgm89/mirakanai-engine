...
Assert-ContainsText ([string]$manifest.gameCodeGuidance.desktopRuntime3dSceneScalePolicyPackageSmoke) "--require-scene-scale-policy" "scene scale policy package guidance"; foreach ($sceneScalePackageCommandGuidance in @("engine/agent/manifest.json", "games/CMakeLists.txt", "games/sample_desktop_runtime_game/game.agent.json", "games/sample_desktop_runtime_game/README.md", "tools/validate-installed-desktop-runtime.ps1")) { Assert-ContainsText (Get-AgentSurfaceText $sceneScalePackageCommandGuidance) "--require-scene-scale-policy" $sceneScalePackageCommandGuidance }; foreach ($sceneScaleInstancedPackageCommandGuidance in @("engine/agent/manifest.json", "games/CMakeLists.txt", "games/sample_desktop_runtime_game/game.agent.json", "games/sample_desktop_runtime_game/README.md", "tools/validate-installed-desktop-runtime.ps1")) { Assert-ContainsText (Get-AgentSurfaceText $sceneScaleInstancedPackageCommandGuidance) "--require-d3d12-instanced-draw-evidence" $sceneScaleInstancedPackageCommandGuidance }
...
foreach ($sceneScalePolicyExpectedField in @('"scene_scale_policy_status" = "ready"', '"scene_scale_policy_ready" = "1"', '"scene_scale_policy_diagnostics" = "0"', '"scene_scale_policy_scene_resources_ready" = "1"', '"scene_scale_policy_instanced_draw_calls" = "0"', '"scene_scale_policy_lod_groups" = "0"', '$requiresD3d12InstancedDrawEvidence', '$expectedSceneScaleBackendInstancingEvidence', '"scene_scale_policy_backend_instancing_evidence_required" = $expectedSceneScaleBackendInstancingEvidence', '"scene_scale_policy_backend_instancing_evidence_ready" = $expectedSceneScaleBackendInstancingEvidence')) { Assert-ContainsText (Get-AgentSurfaceText "tools/validate-installed-desktop-runtime.ps1") $sceneScalePolicyExpectedField "tools/validate-installed-desktop-runtime.ps1" }; foreach ($sceneScaleD3d12InstancedExpectedField in @('"d3d12_instanced_draw_execution_status" = "ready"', '"d3d12_instanced_draw_execution_ready" = "1"', '"d3d12_instanced_draw_execution_selected" = "1"', '"d3d12_instanced_draw_execution_expected_instances"', '"d3d12_instanced_draw_calls"', '"d3d12_instanced_indexed_draw_calls"', '"d3d12_instanced_instances_submitted"', '"d3d12_instanced_draws_ok" = "1"', '"d3d12_instanced_instances_ok" = "1"', '"rhi_instanced_draw_calls"', '"rhi_instanced_indexed_draw_calls"', '"rhi_instanced_instances_submitted"')) { Assert-ContainsText (Get-AgentSurfaceText "tools/validate-installed-desktop-runtime.ps1") $sceneScaleD3d12InstancedExpectedField "tools/validate-installed-desktop-runtime.ps1" }
