...
Assert-ContainsText ([string]$geRendererModule[0].purpose) "RhiPostprocessFrameRenderer scheduled inter-pass plus writer-access-backed post-chain target-state and scene-depth final-state transition adoption" "MK_renderer module purpose"
