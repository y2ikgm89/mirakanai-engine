...
foreach ($rendererPolicyHeader in @("postprocess_policy.hpp", "gpu_memory_policy.hpp", "debug_profiling_policy.hpp", "scene_scale_policy.hpp")) { if (@($geRendererModule[0].publicHeaders) -notcontains "engine/renderer/include/mirakana/renderer/$rendererPolicyHeader") { Write-Error "engine/agent/manifest.json MK_renderer publicHeaders must include $rendererPolicyHeader" } }
...
foreach ($d3d12PostprocessExecutionCodeGuidance in @("engine/runtime_host/sdl3/include/mirakana/runtime_host/sdl3/sdl_desktop_presentation.hpp", "engine/runtime_host/sdl3/src/sdl_desktop_presentation.cpp")) { $d3d12PostprocessExecutionCodeText = Get-AgentSurfaceText $d3d12PostprocessExecutionCodeGuidance; foreach ($needle in @("SdlDesktopPresentationD3d12PostprocessExecutionReport", "evaluate_sdl_desktop_presentation_d3d12_postprocess_execution")) { Assert-ContainsText $d3d12PostprocessExecutionCodeText $needle $d3d12PostprocessExecutionCodeGuidance } }
...
foreach ($vulkanPostprocessExecutionCodeGuidance in @("engine/runtime_host/sdl3/include/mirakana/runtime_host/sdl3/sdl_desktop_presentation.hpp", "engine/runtime_host/sdl3/src/sdl_desktop_presentation.cpp")) { $vulkanPostprocessExecutionCodeText = Get-AgentSurfaceText $vulkanPostprocessExecutionCodeGuidance; foreach ($needle in @("SdlDesktopPresentationVulkanPostprocessExecutionReport", "evaluate_sdl_desktop_presentation_vulkan_postprocess_execution")) { Assert-ContainsText $vulkanPostprocessExecutionCodeText $needle $vulkanPostprocessExecutionCodeGuidance } }
foreach ($needle in @("evaluate_sdl_desktop_presentation_d3d12_postprocess_execution", "evaluate_sdl_desktop_presentation_vulkan_postprocess_execution", "postprocess_d3d12_execution_status", "vulkan_postprocess_execution_status", "--require-d3d12-postprocess-evidence", "--require-vulkan-postprocess-evidence")) { Assert-ContainsText $sampleDesktopRuntimePostprocessPolicyText $needle "games/sample_desktop_runtime_game/main.cpp" }
...
foreach ($sceneScalePolicyCodeGuidance in @("engine/runtime_host/sdl3/include/mirakana/runtime_host/sdl3/sdl_desktop_presentation.hpp", "engine/runtime_host/sdl3/src/sdl_desktop_presentation.cpp")) { $sceneScalePolicyCodeText = Get-AgentSurfaceText $sceneScalePolicyCodeGuidance; foreach ($needle in @("SdlDesktopPresentationSceneScalePolicyReport", "evaluate_sdl_desktop_presentation_scene_scale_policy", "SdlDesktopPresentationD3d12InstancedDrawExecutionReport", "evaluate_sdl_desktop_presentation_d3d12_instanced_draw_execution", "SdlDesktopPresentationVulkanInstancedDrawExecutionReport", "evaluate_sdl_desktop_presentation_vulkan_instanced_draw_execution")) { Assert-ContainsText $sceneScalePolicyCodeText $needle $sceneScalePolicyCodeGuidance } }; foreach ($needle in @("scene_scale_policy_backend_instancing_evidence_ready")) { Assert-ContainsText (Get-AgentSurfaceText "engine/renderer/include/mirakana/renderer/scene_scale_policy.hpp") $needle "engine/renderer/include/mirakana/renderer/scene_scale_policy.hpp" }; foreach ($needle in @("evaluate_sdl_desktop_presentation_scene_scale_policy", "scene_scale_policy_status", "evaluate_sdl_desktop_presentation_d3d12_instanced_draw_execution", "evaluate_sdl_desktop_presentation_vulkan_instanced_draw_execution", "d3d12_instanced_draw_execution_status", "vulkan_instanced_draw_execution_status", "--require-vulkan-instanced-draw-evidence")) { Assert-ContainsText $sampleDesktopRuntimePostprocessPolicyText $needle "games/sample_desktop_runtime_game/main.cpp" }
foreach ($gpuMemoryNeedle in @("GPU Memory Policy v1", "GpuMemoryPolicyDesc", "GpuMemoryPolicyPlan", "GpuMemoryResidencyClass", "plan_gpu_memory_policy", "gpu_memory_policy_backend_evidence_ready", "RhiDeviceMemoryDiagnostics", "memory_diagnostics", "transient_texture_heap_allocations", "upload_bytes_written")) { Assert-ContainsText ([string]$manifest.gameCodeGuidance.currentRendering) $gpuMemoryNeedle "rendering game guidance" }; foreach ($gpuMemoryGuidance in @("engine/agent/manifest.json", "docs/ai-game-development.md", "docs/current-capabilities.md", ".agents/skills/rendering-change/references/full-guidance.md", ".claude/skills/gameengine-rendering/references/full-guidance.md")) { $gpuMemoryText = Get-AgentSurfaceText $gpuMemoryGuidance; foreach ($gpuMemoryNeedle in @("GPU Memory Policy v1", "GpuMemoryPolicyDesc", "plan_gpu_memory_policy")) { Assert-ContainsText $gpuMemoryText $gpuMemoryNeedle $gpuMemoryGuidance } }; Assert-ContainsText ([string]$manifest.gameCodeGuidance.desktopRuntime3dGpuMemoryPolicyPackageSmoke) "--require-gpu-memory-policy" "gpu memory policy package guidance"; foreach ($gpuMemoryPackageCommandGuidance in @("engine/agent/manifest.json", "games/CMakeLists.txt", "games/sample_desktop_runtime_game/game.agent.json", "games/sample_desktop_runtime_game/README.md", "tools/validate-installed-desktop-runtime.ps1")) { $gpuMemoryPackageCommandText = Get-AgentSurfaceText $gpuMemoryPackageCommandGuidance; foreach ($gpuMemoryPackageCommandNeedle in @("--require-gpu-memory-policy", "--require-d3d12-gpu-memory-evidence", "--require-vulkan-gpu-memory-evidence")) { Assert-ContainsText $gpuMemoryPackageCommandText $gpuMemoryPackageCommandNeedle $gpuMemoryPackageCommandGuidance } }; foreach ($gpuMemoryPackageGuidance in @("engine/agent/manifest.json", "games/sample_desktop_runtime_game/game.agent.json", "games/sample_desktop_runtime_game/README.md", "docs/ai-game-development.md", "docs/current-capabilities.md", ".agents/skills/rendering-change/references/full-guidance.md", ".claude/skills/gameengine-rendering/references/full-guidance.md")) { $gpuMemoryPackageText = Get-AgentSurfaceText $gpuMemoryPackageGuidance; foreach ($gpuMemoryPackageNeedle in @("gpu_memory_policy_status=ready", "gpu_memory_policy_ready=1", "gpu_memory_policy_diagnostics=0", "gpu_memory_policy_requests", "gpu_memory_policy_committed_byte_estimate", "gpu_memory_policy_upload_bytes_written", "gpu_memory_policy_backend_memory_evidence_required=1", "gpu_memory_policy_backend_memory_evidence_ready=1", "d3d12_gpu_memory_execution_status=ready", "d3d12_gpu_memory_execution_ready=1", "d3d12_gpu_memory_execution_selected=1", "d3d12_gpu_memory_execution_budget_ok=1", "d3d12_gpu_memory_execution_transient_heap_ok=1", "vulkan_gpu_memory_execution_status=ready", "vulkan_gpu_memory_execution_ready=1", "vulkan_gpu_memory_execution_selected=1", "vulkan_gpu_memory_execution_budget_ok=1", "vulkan_gpu_memory_execution_transient_heap_ok=1")) { Assert-ContainsText $gpuMemoryPackageText $gpuMemoryPackageNeedle $gpuMemoryPackageGuidance } }; foreach ($gpuMemoryValidateNeedle in @('"gpu_memory_policy_status" = "ready"', '"gpu_memory_policy_ready" = "1"', '"gpu_memory_policy_diagnostics" = "0"', '"gpu_memory_policy_scene_resources_ready" = "1"', '$requiresD3d12GpuMemoryEvidence', '$requiresVulkanGpuMemoryEvidence', '$expectedGpuMemoryBackendEvidence', '$expectedGpuMemoryOsVideoBudgetRequired', '"gpu_memory_policy_backend_memory_evidence_required" = $expectedGpuMemoryBackendEvidence', '"gpu_memory_policy_backend_memory_evidence_ready" = $expectedGpuMemoryBackendEvidence', '"gpu_memory_policy_os_video_memory_budget_required" = $expectedGpuMemoryOsVideoBudgetRequired', '"d3d12_gpu_memory_execution_status" = "ready"', '"d3d12_gpu_memory_execution_ready" = "1"', '"d3d12_gpu_memory_execution_selected" = "1"', '"d3d12_gpu_memory_execution_committed_byte_estimate_available" = "1"', '"d3d12_gpu_memory_execution_budget_ok" = "1"', '"d3d12_gpu_memory_execution_transient_heap_ok" = "1"', '"d3d12_gpu_memory_execution_committed_resources_byte_estimate"', '"d3d12_gpu_memory_execution_upload_bytes_written"', '"vulkan_gpu_memory_execution_status" = "ready"', '"vulkan_gpu_memory_execution_ready" = "1"', '"vulkan_gpu_memory_execution_selected" = "1"', '"vulkan_gpu_memory_execution_committed_byte_estimate_available" = "1"', '"vulkan_gpu_memory_execution_budget_ok" = "1"', '"vulkan_gpu_memory_execution_transient_heap_ok" = "1"', '"vulkan_gpu_memory_execution_committed_resources_byte_estimate"', '"vulkan_gpu_memory_execution_upload_bytes_written"', '"vulkan_gpu_memory_execution_framegraph_barrier_steps_executed"')) { Assert-ContainsText (Get-AgentSurfaceText "tools/validate-installed-desktop-runtime.ps1") $gpuMemoryValidateNeedle "tools/validate-installed-desktop-runtime.ps1" }; foreach ($gpuMemoryPolicyCodeGuidance in @("engine/runtime_host/sdl3/include/mirakana/runtime_host/sdl3/sdl_desktop_presentation.hpp", "engine/runtime_host/sdl3/src/sdl_desktop_presentation.cpp")) { $gpuMemoryPolicyCodeText = Get-AgentSurfaceText $gpuMemoryPolicyCodeGuidance; foreach ($needle in @("SdlDesktopPresentationGpuMemoryPolicyReport", "evaluate_sdl_desktop_presentation_gpu_memory_policy", "SdlDesktopPresentationD3d12GpuMemoryExecutionReport", "evaluate_sdl_desktop_presentation_d3d12_gpu_memory_execution", "SdlDesktopPresentationVulkanGpuMemoryExecutionReport", "evaluate_sdl_desktop_presentation_vulkan_gpu_memory_execution")) { Assert-ContainsText $gpuMemoryPolicyCodeText $needle $gpuMemoryPolicyCodeGuidance } }; foreach ($needle in @("gpu_memory_policy_backend_evidence_ready")) { Assert-ContainsText (Get-AgentSurfaceText "engine/renderer/include/mirakana/renderer/gpu_memory_policy.hpp") $needle "engine/renderer/include/mirakana/renderer/gpu_memory_policy.hpp" }; foreach ($needle in @("SdlDesktopPresentationGpuMemoryPolicyDesc", "evaluate_sdl_desktop_presentation_gpu_memory_policy", "evaluate_sdl_desktop_presentation_d3d12_gpu_memory_execution", "evaluate_sdl_desktop_presentation_vulkan_gpu_memory_execution", "gpu_memory_policy_status", "d3d12_gpu_memory_execution_status", "vulkan_gpu_memory_execution_status", "--require-vulkan-gpu-memory-evidence")) { Assert-ContainsText (Get-AgentSurfaceText "games/sample_desktop_runtime_game/main.cpp") $needle "games/sample_desktop_runtime_game/main.cpp" }
foreach ($debugProfilingNeedle in @("Debug Profiling Policy v1", "Backend Renderer Parity", "debug_profiling_policy_backend_evidence_ready", "DebugProfilingPolicyDesc", "DebugProfilingPolicyPlan", "DebugProfilingCaptureKind", "plan_debug_profiling_policy", "gpu_timestamp_ticks_per_second", "gpu_debug_markers_inserted", "gpu_debug_scopes_begun")) { Assert-ContainsText ([string]$manifest.gameCodeGuidance.currentRendering) $debugProfilingNeedle "rendering game guidance" }; foreach ($debugProfilingGuidance in @("engine/agent/manifest.json", "docs/ai-game-development.md", "docs/current-capabilities.md", ".agents/skills/rendering-change/references/full-guidance.md", ".claude/skills/gameengine-rendering/references/full-guidance.md")) { $debugProfilingText = Get-AgentSurfaceText $debugProfilingGuidance; foreach ($debugProfilingNeedle in @("Debug Profiling Policy v1", "DebugProfilingPolicyDesc", "plan_debug_profiling_policy")) { Assert-ContainsText $debugProfilingText $debugProfilingNeedle $debugProfilingGuidance } }; Assert-ContainsText ([string]$manifest.gameCodeGuidance.desktopRuntime3dDebugProfilingPolicyPackageSmoke) "--require-debug-profiling-policy" "debug profiling policy package guidance"; foreach ($debugProfilingPackageCommandGuidance in @("engine/agent/manifest.json", "games/CMakeLists.txt", "games/sample_desktop_runtime_game/game.agent.json", "games/sample_desktop_runtime_game/README.md", "tools/validate-installed-desktop-runtime.ps1")) { $debugProfilingPackageCommandText = Get-AgentSurfaceText $debugProfilingPackageCommandGuidance; foreach ($debugProfilingPackageCommandNeedle in @("--require-debug-profiling-policy", "--require-d3d12-debug-profiling-evidence", "--require-vulkan-debug-profiling-evidence")) { Assert-ContainsText $debugProfilingPackageCommandText $debugProfilingPackageCommandNeedle $debugProfilingPackageCommandGuidance } }; foreach ($debugProfilingPackageGuidance in @("engine/agent/manifest.json", "games/sample_desktop_runtime_game/game.agent.json", "games/sample_desktop_runtime_game/README.md", "docs/ai-game-development.md", "docs/current-capabilities.md", ".agents/skills/rendering-change/references/full-guidance.md", ".claude/skills/gameengine-rendering/references/full-guidance.md")) { $debugProfilingPackageText = Get-AgentSurfaceText $debugProfilingPackageGuidance; foreach ($debugProfilingPackageNeedle in @("debug_profiling_policy_status=ready", "debug_profiling_policy_ready=1", "debug_profiling_policy_diagnostics=0", "debug_profiling_policy_gpu_timestamp_ticks_per_second", "debug_profiling_policy_gpu_debug_markers_inserted", "debug_profiling_policy_backend_profiling_evidence_required=1", "debug_profiling_policy_backend_profiling_evidence_ready=1", "d3d12_debug_profiling_execution_status=ready", "d3d12_debug_profiling_execution_ready=1", "d3d12_debug_profiling_execution_selected=1", "d3d12_debug_profiling_execution_gpu_timestamps_ok=1", "d3d12_debug_profiling_execution_gpu_debug_markers_ok=1", "d3d12_debug_profiling_execution_frame_diagnostics_ok=1", "vulkan_debug_profiling_execution_status=ready", "vulkan_debug_profiling_execution_ready=1", "vulkan_debug_profiling_execution_selected=1", "vulkan_debug_profiling_execution_gpu_debug_markers_ok=1", "vulkan_debug_profiling_execution_frame_diagnostics_ok=1")) { Assert-ContainsText $debugProfilingPackageText $debugProfilingPackageNeedle $debugProfilingPackageGuidance } }; foreach ($debugProfilingValidateNeedle in @('"debug_profiling_policy_status" = "ready"', '"debug_profiling_policy_ready" = "1"', '"debug_profiling_policy_diagnostics" = "0"', '$requiresD3d12DebugProfilingEvidence', '$requiresVulkanDebugProfilingEvidence', '$expectedDebugProfilingBackendEvidence', '"debug_profiling_policy_backend_profiling_evidence_required" = $expectedDebugProfilingBackendEvidence', '"debug_profiling_policy_backend_profiling_evidence_ready" = $expectedDebugProfilingBackendEvidence', '"d3d12_debug_profiling_execution_status" = "ready"', '"d3d12_debug_profiling_execution_ready" = "1"', '"d3d12_debug_profiling_execution_selected" = "1"', '"d3d12_debug_profiling_execution_gpu_timestamps_ok" = "1"', '"d3d12_debug_profiling_execution_gpu_debug_markers_ok" = "1"', '"d3d12_debug_profiling_execution_frame_diagnostics_ok" = "1"', '"d3d12_debug_profiling_execution_gpu_timestamp_ticks_per_second"', '"d3d12_debug_profiling_execution_gpu_debug_markers_inserted"', '"vulkan_debug_profiling_execution_status" = "ready"', '"vulkan_debug_profiling_execution_ready" = "1"', '"vulkan_debug_profiling_execution_selected" = "1"', '"vulkan_debug_profiling_execution_gpu_debug_markers_ok" = "1"', '"vulkan_debug_profiling_execution_frame_diagnostics_ok" = "1"', '"vulkan_debug_profiling_execution_gpu_debug_markers_inserted"')) { Assert-ContainsText (Get-AgentSurfaceText "tools/validate-installed-desktop-runtime.ps1") $debugProfilingValidateNeedle "tools/validate-installed-desktop-runtime.ps1" }; foreach ($debugProfilingPolicyCodeGuidance in @("engine/runtime_host/sdl3/include/mirakana/runtime_host/sdl3/sdl_desktop_presentation.hpp", "engine/runtime_host/sdl3/src/sdl_desktop_presentation.cpp")) { $debugProfilingPolicyCodeText = Get-AgentSurfaceText $debugProfilingPolicyCodeGuidance; foreach ($needle in @("SdlDesktopPresentationDebugProfilingPolicyReport", "evaluate_sdl_desktop_presentation_debug_profiling_policy", "SdlDesktopPresentationD3d12DebugProfilingExecutionReport", "evaluate_sdl_desktop_presentation_d3d12_debug_profiling_execution", "SdlDesktopPresentationVulkanDebugProfilingExecutionReport", "evaluate_sdl_desktop_presentation_vulkan_debug_profiling_execution")) { Assert-ContainsText $debugProfilingPolicyCodeText $needle $debugProfilingPolicyCodeGuidance } }; foreach ($needle in @("debug_profiling_policy_backend_evidence_ready")) { Assert-ContainsText (Get-AgentSurfaceText "engine/renderer/include/mirakana/renderer/debug_profiling_policy.hpp") $needle "engine/renderer/include/mirakana/renderer/debug_profiling_policy.hpp" }; foreach ($needle in @("backend_renderer_parity_proof_matches_selected_backend")) { Assert-ContainsText (Get-AgentSurfaceText "engine/renderer/include/mirakana/renderer/backend_renderer_parity_policy.hpp") $needle "engine/renderer/include/mirakana/renderer/backend_renderer_parity_policy.hpp" }; foreach ($needle in @("SdlDesktopPresentationDebugProfilingPolicyDesc", "evaluate_sdl_desktop_presentation_debug_profiling_policy", "evaluate_sdl_desktop_presentation_d3d12_debug_profiling_execution", "evaluate_sdl_desktop_presentation_vulkan_debug_profiling_execution", "debug_profiling_policy_status", "d3d12_debug_profiling_execution_status", "vulkan_debug_profiling_execution_status", "--require-vulkan-debug-profiling-evidence")) { Assert-ContainsText (Get-AgentSurfaceText "games/sample_desktop_runtime_game/main.cpp") $needle "games/sample_desktop_runtime_game/main.cpp" }
foreach ($gpuMemoryProductionNeedle in @("GpuMemoryPackageCounterDesc", "gpu_memory_policy_package_counter_evidence_required", "gpu_memory_policy_package_counters", "gpu_memory_policy_package_counters_ready", "gpu_memory_policy_residency_pressure_required", "gpu_memory_policy_residency_pressure_ready")) { foreach ($gpuMemoryProductionGuidance in @("engine/agent/manifest.json", "docs/ai-game-development.md", "docs/current-capabilities.md", ".agents/skills/rendering-change/references/full-guidance.md", ".claude/skills/gameengine-rendering/references/full-guidance.md")) { Assert-ContainsText (Get-AgentSurfaceText $gpuMemoryProductionGuidance) $gpuMemoryProductionNeedle $gpuMemoryProductionGuidance } }; foreach ($gpuMemorySampleNeedle in @("gpu_memory_policy_package_counter_evidence_required", "gpu_memory_policy_package_counters", "gpu_memory_policy_package_counters_ready", "gpu_memory_policy_residency_pressure_required", "gpu_memory_policy_residency_pressure_ready")) { Assert-ContainsText (Get-AgentSurfaceText "games/sample_desktop_runtime_game/main.cpp") $gpuMemorySampleNeedle "games/sample_desktop_runtime_game/main.cpp" }; foreach ($debugProfilingProductionNeedle in @("DebugProfilingPackageCounterDesc", "debug_profiling_policy_package_counter_evidence_required", "debug_profiling_policy_package_counters", "debug_profiling_policy_package_counters_ready", "debug_profiling_policy_trace_capture_handoff_review_ready")) { foreach ($debugProfilingProductionGuidance in @("engine/agent/manifest.json", "docs/ai-game-development.md", "docs/current-capabilities.md", ".agents/skills/rendering-change/references/full-guidance.md", ".claude/skills/gameengine-rendering/references/full-guidance.md")) { Assert-ContainsText (Get-AgentSurfaceText $debugProfilingProductionGuidance) $debugProfilingProductionNeedle $debugProfilingProductionGuidance } }; foreach ($debugProfilingSampleNeedle in @("debug_profiling_policy_package_counter_evidence_required", "debug_profiling_policy_package_counters", "debug_profiling_policy_package_counters_ready", "debug_profiling_policy_trace_capture_handoff_review_ready")) { Assert-ContainsText (Get-AgentSurfaceText "games/sample_desktop_runtime_game/main.cpp") $debugProfilingSampleNeedle "games/sample_desktop_runtime_game/main.cpp" }; foreach ($gpuMemoryPolicyHeaderNeedle in @("GpuMemoryPackageCounterDesc", "GpuMemoryPackageCounterKind", "missing_residency_pressure_evidence", "missing_package_counter_evidence")) { Assert-ContainsText (Get-AgentSurfaceText "engine/renderer/include/mirakana/renderer/gpu_memory_policy.hpp") $gpuMemoryPolicyHeaderNeedle "engine/renderer/include/mirakana/renderer/gpu_memory_policy.hpp" }; foreach ($debugProfilingPolicyHeaderNeedle in @("DebugProfilingPackageCounterDesc", "DebugProfilingPackageCounterKind", "missing_cpu_profile_zone_evidence", "missing_profile_budget_evidence", "missing_package_counter_evidence", "missing_trace_capture_handoff_evidence")) { Assert-ContainsText (Get-AgentSurfaceText "engine/renderer/include/mirakana/renderer/debug_profiling_policy.hpp") $debugProfilingPolicyHeaderNeedle "engine/renderer/include/mirakana/renderer/debug_profiling_policy.hpp" }; foreach ($profilingResidencyValidateNeedle in @('$expectedGpuMemoryResidencyPressureRequired', '"gpu_memory_policy_package_counter_evidence_required" = $expectedGpuMemoryBackendEvidence', '"gpu_memory_policy_residency_pressure_required" = $expectedGpuMemoryResidencyPressureRequired', '"debug_profiling_policy_package_counter_evidence_required" = $expectedDebugProfilingBackendEvidence', '"debug_profiling_policy_trace_capture_handoff_review_ready" = $expectedDebugProfilingBackendEvidence', "gpu_memory_policy_package_counters_ready", "debug_profiling_policy_package_counters_ready")) { Assert-ContainsText (Get-AgentSurfaceText "tools/validate-installed-desktop-runtime.ps1") $profilingResidencyValidateNeedle "tools/validate-installed-desktop-runtime.ps1" }
