...
Assert-ContainsText ([string]$productionLoop.recommendedNextPlan.reason) "selected D3D12 generated 3D package upload staging evidence" "recommended next plan reason"
Assert-ContainsText ([string]$productionLoop.recommendedNextPlan.reason) "async-ready resource updates" "recommended next plan reason"
