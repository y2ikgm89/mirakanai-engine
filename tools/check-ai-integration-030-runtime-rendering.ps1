...
foreach ($requiredNeedle in @("Windows-native editor/developer shell", "first-party retained", "MK_ui_renderer", "EditorDockLayout", "editor_dock_panel_catalog", "EditorDockCommandPlan", "plan_editor_dock_command", "apply_editor_dock_command", "EditorRichTextDocument", "EditorRichTextViewport", "make_editor_ai_command_panel_rich_text_document", "make_editor_inspector_rich_text_document", "make_editor_rich_text_ai_snapshot", "private Windows SDK DirectWrite text-layout/glyph-raster adapters", "selected text atlas handoff evidence", "first-party value-only focused text-input/IME controller rows", "ITextShapingAdapter", "IFontRasterizerAdapter", "Console diagnostics", "AI Commands panel status/command/evidence rows", "Inspector property rows as read-only rich-text spans", "input_rebinding remains a workspace panel outside the current native shell panel set", "editor_shell_ui=first_party", "editor_shell_backend=d3d12", "editor_shell_imgui=0", "editor_shell_panels=11", "editor_shell_docking_status=single_window_ready", "editor_shell_dock_tab_headers=11", "editor_shell_dock_split_gutters=3", "editor_shell_dock_active_panels=4", "editor_shell_dock_focusable_controls=11", "editor_shell_viewport_status=diagnostic_only", "editor_shell_viewport_native_handles_exposed=0", "editor_shell_material_preview_status=diagnostic_only", "editor_shell_material_preview_native_handles_exposed=0", "editor_shell_text_atlas_handoff_status=glyphs_ready_atlas_handoff_host_gated", "editor_shell_text_font_adapter_invoked=1", "editor_shell_text_font_glyphs_ready=1", "editor_shell_text_font_fallback_used=0", "editor_shell_text_atlas_handoff_host_gated_rows=1", "editor_shell_text_atlas_handoff_unsupported_rows=1", "editor_shell_text_font_native_handles_exposed=0", "editor_shell_ime_status=value_text_input_controller_ready", "editor_shell_ime_caret_rect_rows=1", "editor_shell_ime_surrounding_text_rows=1", "editor_shell_ime_native_handles_exposed=0", "editor_shell_renderer_boxes_submitted", "editor_shell_renderer_text_runs_available", "--no-user-config", "Resources panel refreshes D3D12 host availability", "private D3D12 texture adapters", "material-preview GPU parity remains unsupported", "runtime game UI Dear ImGui usage")) { Assert-ContainsText $currentEditorGuidance $requiredNeedle "gameCodeGuidance.currentEditor native shell" }
