...
foreach ($requiredNeedle in @("make_native_editor_imgui_user_config_policy", "IniFilename = nullptr", "LogFilename = nullptr", "record_native_resource_device_ready", "record_native_material_preview_d3d12_host_ready", "render_native_editor_panels")) { Assert-ContainsText $editorHostText $requiredNeedle "native editor shell host" }
