    ...
    if ($requiresEnvironmentOptimizationMeasurement) {
        Assert-InstalledDesktopRuntimeStatusFields `
            ...
            -ExpectedFields @{
                ...
                "environment_optimization_measurement_workload_rows" = "2"
                "environment_optimization_measurement_required_workloads" = "7"
                "environment_optimization_measurement_measured_workloads" = "2"
                "environment_optimization_measurement_before_after_pairs" = "2"
                ...
                "environment_optimization_measurement_regression_budget_rows" = "2"
