    ...
    if ($requiresEnvironmentTextureAssetPipelinePackage) {
        Assert-InstalledDesktopRuntimeStatusFields `
            ...
            -ExpectedFields @{
                ...
                "environment_texture_asset_pipeline_payload_records" = "2"
                ...
                "environment_texture_asset_pipeline_payload_byte_rows" = "2"
                "environment_texture_asset_pipeline_payload_hash_rows" = "2"
