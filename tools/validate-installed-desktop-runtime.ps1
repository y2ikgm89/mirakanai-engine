    ...
    if ($requiresEnvironmentOptimizationMeasurement) {
        Assert-InstalledDesktopRuntimeStatusFields `
            ...
            -ExpectedFields @{
                ...
                "environment_optimization_measurement_workload_rows" = "6"
                "environment_optimization_measurement_required_workloads" = "7"
                "environment_optimization_measurement_measured_workloads" = "6"
                "environment_optimization_measurement_before_after_pairs" = "6"
                "environment_optimization_measurement_backend" = "d3d12"
                "environment_optimization_measurement_profile" = "preset_pack_flythrough"
                "environment_optimization_measurement_profiles" = "preset_pack_flythrough,storm_precipitation,dense_volumetric_fog,volumetric_cloud_sunset,snowfield_material_weathering,weather_simulation_stress"
                ...
                "environment_optimization_measurement_regression_budget_rows" = "6"
