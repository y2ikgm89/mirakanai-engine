...
$requiresEnvironmentCommercialVulkanEvidence = @($SmokeArgs) -contains "--require-environment-commercial-vulkan-evidence"
$requiresEnvironmentCommercialReadinessFlag = @($SmokeArgs) -contains "--require-environment-commercial-readiness"
$requiresEnvironmentCommercialReadiness = $requiresEnvironmentCommercialReadinessFlag -or
    $requiresEnvironmentCommercialVulkanEvidence
$requiresEnvironmentCommercialFullReadiness = $requiresEnvironmentCommercialReadinessFlag -and
    -not $requiresEnvironmentCommercialVulkanEvidence
$requiresEnvironmentPlatformWindowsVulkanEvidence = @($SmokeArgs) -contains "--require-environment-platform-windows-vulkan-evidence"
...
$requiresEnvironmentD3d12PlatformReadiness = $requiresEnvironmentPlatformReadinessFlag -or
    $requiresEnvironmentCommercialFullReadiness
$requiresEnvironmentPlatformReadiness = $requiresEnvironmentD3d12PlatformReadiness -or
    $requiresEnvironmentPlatformWindowsVulkanEvidence -or
    $requiresEnvironmentCommercialFullReadiness
...
if ($requiresWindowsCpuSetWorkerPlacement -or $requiresWindowsCpuSetSmtWorkerPlacement) {
    ...
    $requiresJobExecutionPlacementPolicy = $true
}
...
function Assert-InstalledLongRunReadinessEvidence {
    ...
    foreach ($expected in @{
            ...
            "long_run_readiness_numa_locality_status" = "ready"
            "long_run_readiness_numa_locality_ready" = "1"
            "long_run_readiness_numa_node_count" = "1"
            "long_run_readiness_numa_first_touch_default" = "1"
            "long_run_readiness_numa_first_touch_chunk_rows" = "4"
            "long_run_readiness_numa_manual_memory_policy_applied" = "0"
            "long_run_readiness_numa_memory_policy_scope" = "first_touch_locality"
            "long_run_readiness_numa_memory_policy_comparison_status" = "ready"
            "long_run_readiness_numa_memory_policy_recommendation" = "keep_first_touch_default"
            "long_run_readiness_numa_first_touch_local_fraction_per_mille" = "1000"
            "long_run_readiness_numa_manual_local_fraction_per_mille" = "1000"
            "long_run_readiness_numa_manual_policy_locality_gain_per_mille" = "0"
...
if ($GameTarget -eq "sample_desktop_runtime_game") {
    ...
    if ($requiresEnvironmentTextureAssetPipelinePackage) {
        Assert-InstalledDesktopRuntimeStatusFields `
            ...
            -ExpectedFields @{
                ...
                "environment_texture_asset_pipeline_package_index_entries" = "3"
                "environment_texture_asset_pipeline_metadata_records" = "3"
                "environment_texture_asset_pipeline_metadata_only_records" = "0"
                "environment_texture_asset_pipeline_payload_records" = "3"
                "environment_texture_asset_pipeline_openexr_records" = "2"
                "environment_texture_asset_pipeline_ktx2_basis_records" = "1"
                "environment_texture_asset_pipeline_source_hash_rows" = "3"
                "environment_texture_asset_pipeline_provenance_rows" = "3"
                "environment_texture_asset_pipeline_license_rows" = "3"
                "environment_texture_asset_pipeline_backend_policy_rows" = "15"
                "environment_texture_asset_pipeline_payload_byte_rows" = "3"
                "environment_texture_asset_pipeline_payload_hash_rows" = "3"
                "environment_texture_asset_pipeline_unsupported_host_diagnostics" = "12"
                "environment_texture_asset_pipeline_profile_dependency_refs" = "2"
                "environment_texture_asset_pipeline_dependency_edges" = "2"
                "environment_texture_asset_pipeline_upload_plan_records" = "3"
                "environment_texture_asset_pipeline_upload_plan_ready_records" = "1"
                "environment_texture_asset_pipeline_upload_plan_diagnostics" = "3"
                "environment_texture_asset_pipeline_upload_plan_payload_bytes" = "4"
                "environment_texture_asset_pipeline_upload_plan_source_bytes" = "4"
                "environment_texture_asset_pipeline_pixel_decode_invoked" = "1"
                "environment_texture_asset_pipeline_basis_runtime_transcode_invoked" = "1"
                "environment_texture_asset_pipeline_gpu_upload_invoked" = "0"
                "environment_texture_asset_pipeline_broad_ready" = "0"
                "environment_texture_asset_pipeline_upload_plan_runtime_codec_invoked" = "0"
                "environment_texture_asset_pipeline_upload_plan_runtime_basis_transcode_invoked" = "0"
                "environment_texture_asset_pipeline_upload_plan_backend_api_invoked" = "0"
                "environment_texture_asset_pipeline_upload_plan_gpu_upload_invoked" = "0"
    ...
    if ($requiresWindowsCpuSetWorkerPlacement) {
        $expectedWindowsCpuSetWorkerPlacementFields = @{
            "windows_cpu_set_worker_placement_status" = "ready"
            "windows_cpu_set_worker_placement_ready" = "1"
            "windows_cpu_set_worker_placement_pool_status" = "ready"
            "windows_cpu_set_worker_placement_run_status" = "ready"
            "windows_cpu_set_worker_placement_diagnostics" = "0"
            "windows_cpu_set_worker_placement_topology_rows" = "1"
            "windows_cpu_set_worker_placement_worker_rows" = "2"
            "windows_cpu_set_worker_placement_worker_threads_started" = "2"
            "windows_cpu_set_worker_placement_attempts" = "2"
            "windows_cpu_set_worker_placement_applied" = "2"
            "windows_cpu_set_worker_placement_selected_cpu_set_applications" = "2"
            "windows_cpu_set_worker_placement_tasks_submitted" = "2"
            "windows_cpu_set_worker_placement_tasks_executed" = "2"
            "windows_cpu_set_worker_placement_tasks_failed" = "0"
            "windows_cpu_set_worker_placement_task_side_effects" = "2"
        ...
        foreach ($field in $expectedWindowsCpuSetWorkerPlacementFields.Keys) {
            $expectedValue = [regex]::Escape($expectedWindowsCpuSetWorkerPlacementFields[$field])
            if ($smokeOutput -notmatch "(?m)^$escapedGameTarget status=.*\b$field=$expectedValue\b") {
                Write-Error "Installed sample_desktop_runtime_game smoke status line did not prove Windows CPU Set worker placement field: $field=$($expectedWindowsCpuSetWorkerPlacementFields[$field])"
            }
        }
...
if ($smokeOutput -match "(?m)^$escapedGameTarget status=.*\bscene_gpu_status=ready") {
    ...
    if ($requiresPostprocess) {
        ...
        if ($requiresEnvironmentVolumetricCloudVulkanRendererExecution) {
            ...
            $expectedEnvironmentVolumetricCloudVulkanFields = @{
                "environment_volumetric_cloud_vulkan_status" = "ready"
                "environment_volumetric_cloud_vulkan_ready" = "1"
                "environment_volumetric_cloud_vulkan_selected_backend" = "vulkan"
                "environment_volumetric_cloud_vulkan_requested" = "1"
                "environment_volumetric_cloud_vulkan_shader_contract_evidence_ready" = "1"
                "environment_volumetric_cloud_vulkan_package_evidence_ready" = "1"
                "environment_volumetric_cloud_vulkan_execution_evidence_ready" = "1"
                "environment_volumetric_cloud_vulkan_weather_map_binding" = "10"
                "environment_volumetric_cloud_vulkan_shape_noise_binding" = "11"
                "environment_volumetric_cloud_vulkan_erosion_noise_binding" = "12"
                "environment_volumetric_cloud_vulkan_sampler_binding" = "30"
                "environment_volumetric_cloud_vulkan_constants_binding" = "48"
                "environment_volumetric_cloud_vulkan_constants_byte_size" = "256"
                "environment_volumetric_cloud_vulkan_weather_map_ready" = "1"
                "environment_volumetric_cloud_vulkan_shape_noise_ready" = "1"
                "environment_volumetric_cloud_vulkan_erosion_noise_ready" = "1"
                "environment_volumetric_cloud_vulkan_map_rows" = "1"
                "environment_volumetric_cloud_vulkan_layer_rows" = "1"
                "environment_volumetric_cloud_vulkan_lighting_rows" = "1"
                "environment_volumetric_cloud_vulkan_raymarch_rows" = "1"
                "environment_volumetric_cloud_vulkan_temporal_rows" = "1"
                "environment_volumetric_cloud_vulkan_shadow_rows" = "1"
                "environment_volumetric_cloud_vulkan_storm_rows" = "1"
                "environment_volumetric_cloud_vulkan_shader_contract_rows" = "1"
                "environment_volumetric_cloud_vulkan_quality_rows" = "1"
                "environment_volumetric_cloud_vulkan_descriptor_set_bindings" = "5"
                "environment_volumetric_cloud_vulkan_readback_nonzero" = "1"
                "environment_volumetric_cloud_vulkan_native_handle_access" = "0"
                "environment_volumetric_cloud_vulkan_audio_playback" = "0"
                "environment_volumetric_cloud_vulkan_precipitation_execution" = "0"
                "environment_volumetric_cloud_vulkan_diagnostics" = "0"
            }
            foreach ($field in $expectedEnvironmentVolumetricCloudVulkanFields.Keys) {
                $expectedValue = [regex]::Escape($expectedEnvironmentVolumetricCloudVulkanFields[$field])
                if ($smokeOutput -notmatch "(?m)^$escapedGameTarget status=.*\b$field=$expectedValue\b") {
                    Write-Error "Installed desktop runtime smoke status line did not prove Vulkan environment volumetric cloud renderer execution field: $field=$($expectedEnvironmentVolumetricCloudVulkanFields[$field])"
                }
            }
            foreach ($field in @(
                ...
                if ($smokeOutput -notmatch "(?m)^$escapedGameTarget status=.*\b$field=([1-9][0-9]*)\b") {
                    Write-Error "Installed desktop runtime smoke status line did not prove positive Vulkan environment volumetric cloud renderer execution field: $field"
                }
            }
        }
        if ($requiresCloudLayerPackageEvidence) {
    ...
    if ($requiresAnyEnvironmentQualityBudget) {
        ...
        if ($requiresEnvironmentVolumetricCloudPackageEvidence -or $requiresEnvironmentVolumetricCloudVulkanRendererExecution) {
            ++$expectedEnvironmentQualityBudgetRows
            $expectedEnvironmentQualityBudgetConstantBytes += 256
            $expectedEnvironmentQualityBudgetVolumetricCloudPrimary = 48
            $expectedEnvironmentQualityBudgetVolumetricCloudLight = 8
            if ($requiresEnvironmentVolumetricCloudRendererExecution -or $requiresEnvironmentVolumetricCloudVulkanRendererExecution) {
    ...
    if ($requiresEnvironmentPlatformReadiness) {
        $environmentPlatformExpectedFields = @{
            "environment_platform_readiness_status" = "host_evidence_required"
            "environment_platform_readiness_ready" = "0"
            "environment_platform_windows_vulkan_evidence_requested" = "0"
            "environment_platform_windows_vulkan_strict_aggregate_ready" = "0"
        ...
        if ($requiresEnvironmentPlatformWindowsVulkanEvidence) {
            $environmentPlatformExpectedFields["environment_platform_windows_vulkan_evidence_requested"] = "1"
            $environmentPlatformExpectedFields["environment_platform_windows_vulkan_strict_aggregate_ready"] = "1"
            $environmentPlatformExpectedFields["environment_platform_windows_d3d12_ready"] = "0"
            $environmentPlatformExpectedFields["environment_platform_windows_vulkan_ready"] = "1"
            $environmentPlatformExpectedFields["environment_platform_requires_windows_vulkan_host_evidence"] = "0"
        }
        Assert-InstalledDesktopRuntimeStatusFields `
            -SmokeOutput $smokeOutput `
            -EscapedGameTarget $escapedGameTarget `
            -Context "environment platform readiness" `
            -ExpectedFields $environmentPlatformExpectedFields
    ...
    if ($requiresEnvironmentOptimizationMeasurement) {
        ...
        Assert-InstalledDesktopRuntimeStatusFields `
            ...
            -ExpectedFields @{
                ...
                "environment_optimization_measurement_workload_rows" = "7"
                ...
                "environment_optimization_storm_precipitation_ready" = "1"
                "environment_optimization_storm_precipitation_warmup_frames" = "30"
                "environment_optimization_storm_precipitation_sample_frames" = "120"
                "environment_optimization_storm_precipitation_cpu_frame_p95_before_us" = "18200"
                "environment_optimization_storm_precipitation_cpu_frame_p95_after_us" = "17000"
                "environment_optimization_storm_precipitation_gpu_frame_p95_before_us" = "16800"
                "environment_optimization_storm_precipitation_gpu_frame_p95_after_us" = "15800"
                "environment_optimization_storm_precipitation_memory_peak_before_bytes" = "671088640"
                "environment_optimization_storm_precipitation_memory_peak_after_bytes" = "650117120"
                "environment_optimization_storm_precipitation_transient_gpu_before_bytes" = "167772160"
                "environment_optimization_storm_precipitation_transient_gpu_after_bytes" = "150994944"
                "environment_optimization_storm_precipitation_upload_before_bytes" = "50331648"
                "environment_optimization_storm_precipitation_upload_after_bytes" = "41943040"
                "environment_optimization_storm_precipitation_draw_count_before" = "180"
                "environment_optimization_storm_precipitation_draw_count_after" = "168"
                "environment_optimization_storm_precipitation_dispatch_count_before" = "12"
                "environment_optimization_storm_precipitation_dispatch_count_after" = "12"
                "environment_optimization_storm_precipitation_barrier_count_before" = "60"
                "environment_optimization_storm_precipitation_barrier_count_after" = "52"
                "environment_optimization_storm_precipitation_texture_residency_before_bytes" = "545259520"
                "environment_optimization_storm_precipitation_texture_residency_after_bytes" = "515899392"
                "environment_optimization_storm_precipitation_package_load_before_us" = "52000"
                "environment_optimization_storm_precipitation_package_load_after_us" = "47000"
                "environment_optimization_storm_precipitation_stutter_frames_before" = "2"
                "environment_optimization_storm_precipitation_stutter_frames_after" = "1"
                "environment_optimization_dense_volumetric_fog_ready" = "1"
                "environment_optimization_dense_volumetric_fog_warmup_frames" = "30"
                "environment_optimization_dense_volumetric_fog_sample_frames" = "120"
                "environment_optimization_dense_volumetric_fog_cpu_frame_p95_before_us" = "17600"
                "environment_optimization_dense_volumetric_fog_cpu_frame_p95_after_us" = "16500"
                "environment_optimization_dense_volumetric_fog_gpu_frame_p95_before_us" = "16200"
                "environment_optimization_dense_volumetric_fog_gpu_frame_p95_after_us" = "15000"
                "environment_optimization_dense_volumetric_fog_memory_peak_before_bytes" = "738197504"
                "environment_optimization_dense_volumetric_fog_memory_peak_after_bytes" = "713031680"
                "environment_optimization_dense_volumetric_fog_transient_gpu_before_bytes" = "234881024"
                "environment_optimization_dense_volumetric_fog_transient_gpu_after_bytes" = "201326592"
                "environment_optimization_dense_volumetric_fog_upload_before_bytes" = "37748736"
                "environment_optimization_dense_volumetric_fog_upload_after_bytes" = "33554432"
                "environment_optimization_dense_volumetric_fog_draw_count_before" = "130"
                "environment_optimization_dense_volumetric_fog_draw_count_after" = "128"
                "environment_optimization_dense_volumetric_fog_dispatch_count_before" = "24"
                "environment_optimization_dense_volumetric_fog_dispatch_count_after" = "20"
                "environment_optimization_dense_volumetric_fog_barrier_count_before" = "72"
                "environment_optimization_dense_volumetric_fog_barrier_count_after" = "60"
                "environment_optimization_dense_volumetric_fog_texture_residency_before_bytes" = "637534208"
                "environment_optimization_dense_volumetric_fog_texture_residency_after_bytes" = "612368384"
                "environment_optimization_dense_volumetric_fog_package_load_before_us" = "54000"
                "environment_optimization_dense_volumetric_fog_package_load_after_us" = "50000"
                "environment_optimization_dense_volumetric_fog_stutter_frames_before" = "2"
                "environment_optimization_dense_volumetric_fog_stutter_frames_after" = "1"
                "environment_optimization_volumetric_cloud_sunset_ready" = "1"
                "environment_optimization_volumetric_cloud_sunset_warmup_frames" = "30"
                "environment_optimization_volumetric_cloud_sunset_sample_frames" = "120"
                "environment_optimization_volumetric_cloud_sunset_cpu_frame_p95_before_us" = "18800"
                "environment_optimization_volumetric_cloud_sunset_cpu_frame_p95_after_us" = "17600"
                "environment_optimization_volumetric_cloud_sunset_gpu_frame_p95_before_us" = "17400"
                "environment_optimization_volumetric_cloud_sunset_gpu_frame_p95_after_us" = "16200"
                "environment_optimization_volumetric_cloud_sunset_memory_peak_before_bytes" = "805306368"
                "environment_optimization_volumetric_cloud_sunset_memory_peak_after_bytes" = "780140544"
                "environment_optimization_volumetric_cloud_sunset_transient_gpu_before_bytes" = "268435456"
                "environment_optimization_volumetric_cloud_sunset_transient_gpu_after_bytes" = "234881024"
                "environment_optimization_volumetric_cloud_sunset_upload_before_bytes" = "67108864"
                "environment_optimization_volumetric_cloud_sunset_upload_after_bytes" = "58720256"
                "environment_optimization_volumetric_cloud_sunset_draw_count_before" = "150"
                "environment_optimization_volumetric_cloud_sunset_draw_count_after" = "146"
                "environment_optimization_volumetric_cloud_sunset_dispatch_count_before" = "28"
                "environment_optimization_volumetric_cloud_sunset_dispatch_count_after" = "24"
                "environment_optimization_volumetric_cloud_sunset_barrier_count_before" = "84"
                "environment_optimization_volumetric_cloud_sunset_barrier_count_after" = "72"
                "environment_optimization_volumetric_cloud_sunset_texture_residency_before_bytes" = "704643072"
                "environment_optimization_volumetric_cloud_sunset_texture_residency_after_bytes" = "671088640"
                "environment_optimization_volumetric_cloud_sunset_package_load_before_us" = "60000"
                "environment_optimization_volumetric_cloud_sunset_package_load_after_us" = "56000"
                "environment_optimization_volumetric_cloud_sunset_stutter_frames_before" = "3"
                "environment_optimization_volumetric_cloud_sunset_stutter_frames_after" = "2"
                "environment_optimization_snowfield_material_weathering_ready" = "1"
                "environment_optimization_snowfield_material_weathering_warmup_frames" = "30"
                "environment_optimization_snowfield_material_weathering_sample_frames" = "120"
                "environment_optimization_snowfield_material_weathering_cpu_frame_p95_before_us" = "16900"
                "environment_optimization_snowfield_material_weathering_cpu_frame_p95_after_us" = "15800"
                "environment_optimization_snowfield_material_weathering_gpu_frame_p95_before_us" = "15600"
                "environment_optimization_snowfield_material_weathering_gpu_frame_p95_after_us" = "14600"
                "environment_optimization_snowfield_material_weathering_memory_peak_before_bytes" = "738197504"
                "environment_optimization_snowfield_material_weathering_memory_peak_after_bytes" = "721420288"
                "environment_optimization_snowfield_material_weathering_transient_gpu_before_bytes" = "201326592"
                "environment_optimization_snowfield_material_weathering_transient_gpu_after_bytes" = "184549376"
                "environment_optimization_snowfield_material_weathering_upload_before_bytes" = "44040192"
                "environment_optimization_snowfield_material_weathering_upload_after_bytes" = "35651584"
                "environment_optimization_snowfield_material_weathering_draw_count_before" = "164"
                "environment_optimization_snowfield_material_weathering_draw_count_after" = "158"
                "environment_optimization_snowfield_material_weathering_dispatch_count_before" = "16"
                "environment_optimization_snowfield_material_weathering_dispatch_count_after" = "14"
                "environment_optimization_snowfield_material_weathering_barrier_count_before" = "64"
                "environment_optimization_snowfield_material_weathering_barrier_count_after" = "56"
                "environment_optimization_snowfield_material_weathering_texture_residency_before_bytes" = "637534208"
                "environment_optimization_snowfield_material_weathering_texture_residency_after_bytes" = "620756992"
                "environment_optimization_snowfield_material_weathering_package_load_before_us" = "53000"
                "environment_optimization_snowfield_material_weathering_package_load_after_us" = "50000"
                "environment_optimization_snowfield_material_weathering_stutter_frames_before" = "2"
                "environment_optimization_snowfield_material_weathering_stutter_frames_after" = "1"
                "environment_optimization_weather_simulation_stress_ready" = "1"
                "environment_optimization_weather_simulation_stress_warmup_frames" = "30"
                "environment_optimization_weather_simulation_stress_sample_frames" = "120"
                "environment_optimization_weather_simulation_stress_cpu_frame_p95_before_us" = "19600"
                "environment_optimization_weather_simulation_stress_cpu_frame_p95_after_us" = "18100"
                "environment_optimization_weather_simulation_stress_gpu_frame_p95_before_us" = "18400"
                "environment_optimization_weather_simulation_stress_gpu_frame_p95_after_us" = "16900"
                "environment_optimization_weather_simulation_stress_memory_peak_before_bytes" = "872415232"
                "environment_optimization_weather_simulation_stress_memory_peak_after_bytes" = "847249408"
                "environment_optimization_weather_simulation_stress_transient_gpu_before_bytes" = "301989888"
                "environment_optimization_weather_simulation_stress_transient_gpu_after_bytes" = "268435456"
                "environment_optimization_weather_simulation_stress_upload_before_bytes" = "75497472"
                "environment_optimization_weather_simulation_stress_upload_after_bytes" = "62914560"
                "environment_optimization_weather_simulation_stress_draw_count_before" = "172"
                "environment_optimization_weather_simulation_stress_draw_count_after" = "164"
                "environment_optimization_weather_simulation_stress_dispatch_count_before" = "36"
                "environment_optimization_weather_simulation_stress_dispatch_count_after" = "32"
                "environment_optimization_weather_simulation_stress_barrier_count_before" = "96"
                "environment_optimization_weather_simulation_stress_barrier_count_after" = "84"
                "environment_optimization_weather_simulation_stress_texture_residency_before_bytes" = "771751936"
                "environment_optimization_weather_simulation_stress_texture_residency_after_bytes" = "738197504"
                "environment_optimization_weather_simulation_stress_package_load_before_us" = "64000"
                "environment_optimization_weather_simulation_stress_package_load_after_us" = "60000"
                "environment_optimization_weather_simulation_stress_stutter_frames_before" = "4"
                "environment_optimization_weather_simulation_stress_stutter_frames_after" = "2"
                "environment_optimization_asset_library_cold_load_ready" = "1"
                "environment_optimization_asset_library_cold_load_warmup_frames" = "30"
                "environment_optimization_asset_library_cold_load_sample_frames" = "120"
                "environment_optimization_asset_library_cold_load_cpu_frame_p95_before_us" = "14800"
                "environment_optimization_asset_library_cold_load_cpu_frame_p95_after_us" = "13900"
                "environment_optimization_asset_library_cold_load_gpu_frame_p95_before_us" = "13600"
                "environment_optimization_asset_library_cold_load_gpu_frame_p95_after_us" = "12800"
                "environment_optimization_asset_library_cold_load_memory_peak_before_bytes" = "1006632960"
                "environment_optimization_asset_library_cold_load_memory_peak_after_bytes" = "956301312"
                "environment_optimization_asset_library_cold_load_transient_gpu_before_bytes" = "335544320"
                "environment_optimization_asset_library_cold_load_transient_gpu_after_bytes" = "301989888"
                "environment_optimization_asset_library_cold_load_upload_before_bytes" = "134217728"
                "environment_optimization_asset_library_cold_load_upload_after_bytes" = "100663296"
                "environment_optimization_asset_library_cold_load_draw_count_before" = "96"
                "environment_optimization_asset_library_cold_load_draw_count_after" = "92"
                "environment_optimization_asset_library_cold_load_dispatch_count_before" = "20"
                "environment_optimization_asset_library_cold_load_dispatch_count_after" = "18"
                "environment_optimization_asset_library_cold_load_barrier_count_before" = "72"
                "environment_optimization_asset_library_cold_load_barrier_count_after" = "64"
                "environment_optimization_asset_library_cold_load_texture_residency_before_bytes" = "939524096"
                "environment_optimization_asset_library_cold_load_texture_residency_after_bytes" = "872415232"
                "environment_optimization_asset_library_cold_load_package_load_before_us" = "98000"
                "environment_optimization_asset_library_cold_load_package_load_after_us" = "78000"
                "environment_optimization_asset_library_cold_load_stutter_frames_before" = "5"
                "environment_optimization_asset_library_cold_load_stutter_frames_after" = "2"
                "environment_optimization_measurement_regression_budget_rows" = "7"
    ...
    if ($requiresEnvironmentCommercialReadiness) {
        $commercialReadyRows = if ($requiresEnvironmentCommercialVulkanEvidence) { "3" } else { "4" }
        $commercialHostGatedRows = if ($requiresEnvironmentCommercialVulkanEvidence) { "5" } else { "7" }
        $commercialBlockedRows = if ($requiresEnvironmentCommercialVulkanEvidence) { "6" } else { "3" }
        $commercialVulkanEvidenceReady = if ($requiresEnvironmentCommercialVulkanEvidence) { "1" } else { "0" }
        Assert-InstalledDesktopRuntimeStatusFields `
            -SmokeOutput $smokeOutput `
            -EscapedGameTarget $escapedGameTarget `
            ...
            -ExpectedFields @{
                ...
                "environment_commercial_ready_rows" = $commercialReadyRows
                "environment_commercial_host_gated_rows" = $commercialHostGatedRows
                "environment_commercial_blocked_rows" = $commercialBlockedRows
                ...
                "environment_commercial_vulkan_evidence_requested" = $commercialVulkanEvidenceReady
                "environment_commercial_strict_vulkan_aggregate_ready" = $commercialVulkanEvidenceReady
                "environment_commercial_windows_vulkan_ready" = $commercialVulkanEvidenceReady
            }
    ...
    if ($requiresEnvironmentVulkanStrictAggregate) {
        Assert-InstalledDesktopRuntimeStatusFields `
            ...
            -ExpectedFields @{
                ...
                "environment_vulkan_strict_aggregate_toolchain_ready" = "1"
                "environment_vulkan_strict_aggregate_vulkan_sdk_tools_ready" = "1"
                "environment_vulkan_strict_aggregate_dxc_spirv_codegen_ready" = "1"
                "environment_vulkan_strict_aggregate_spirv_validation_ready" = "1"
                "environment_vulkan_strict_aggregate_validation_layers_ready" = "1"
                "environment_vulkan_strict_aggregate_device_features_ready" = "1"
                "environment_vulkan_strict_aggregate_toolchain_rows" = "6"
                "environment_vulkan_strict_aggregate_missing_toolchain_rows" = "0"
                "environment_vulkan_strict_aggregate_missing_validation_layer_rows" = "0"
                "environment_vulkan_strict_aggregate_missing_spirv_validation_rows" = "0"
                ...
                "environment_vulkan_strict_aggregate_attachment_usage_layout_rows" = "2"
                "environment_vulkan_strict_aggregate_sampled_texture_usage_layout_rows" = "6"
                "environment_vulkan_strict_aggregate_storage_buffer_usage_layout_rows" = "2"
                "environment_vulkan_strict_aggregate_cube_map_usage_layout_rows" = "1"
                "environment_vulkan_strict_aggregate_weather_texture_usage_layout_rows" = "3"
                "environment_vulkan_strict_aggregate_froxel_buffer_usage_layout_rows" = "1"
                "environment_vulkan_strict_aggregate_readback_resource_usage_layout_rows" = "5"
