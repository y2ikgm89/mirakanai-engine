...
Assert-ContainsText (Get-Content -LiteralPath $manifestPath -Raw) "validate.ps1 -StaticOnly" "engine/agent/manifest.json"
...
Assert-ContainsText $agentsContent '`Agent Static Guards` runs `validate.ps1 -StaticOnly`' "AGENTS.md"
...
Assert-ContainsText (Get-AgentSurfaceText "docs/workflows.md") "tools/validate.ps1 -StaticOnly" "docs/workflows.md"
