...
Assert-ContainsText $mavgClusterCookSourceText "serialize_mavg_cluster_payload_document" "engine/tools/asset/mavg_cluster_cook.cpp"; Assert-ContainsText $mavgClusterCookSourceText "AssetKind::mavg_cluster_graph" "engine/tools/asset/mavg_cluster_cook.cpp"
