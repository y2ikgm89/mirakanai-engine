...
$agentSurfaceChecksContent = Get-AgentSurfaceText "tools/check-ai-integration-040-agent-surfaces.ps1"
Assert-ContainsText $agentSurfaceChecksContent "Assert-NoLiveVersionSuffixContractText" "tools/check-ai-integration-040-agent-surfaces.ps1"
Assert-ContainsText $agentSurfaceChecksContent "live contract text must not retain removable version suffix" "tools/check-ai-integration-040-agent-surfaces.ps1"
