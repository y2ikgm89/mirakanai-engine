...
Assert-ContainsText $agentsContent "pwsh -NoProfile -ExecutionPolicy Bypass -File tools/remove-merged-worktree.ps1 -WorktreePath <path> [-BaseRef origin/main] [-BaseBranch main] [-Remote origin] [-LocalCheckoutPath <path>] [-DeleteLocalBranch] [-DeleteRemoteBranch]" "AGENTS.md"
Assert-ContainsText $agentsContent "fast-forwards" "AGENTS.md"
Assert-ContainsText $agentsContent "verifies local and remote branch ancestry" "AGENTS.md"
