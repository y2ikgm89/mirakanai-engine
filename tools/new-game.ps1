...
if ($Template -eq "Headless") {
    ...
    $runtimeConfig = @"
format=GameEngine.GeneratedDesktopRuntimePackage.Config
name=$Name
...
"@
    ...
    $runtimeConfig = @"
format=GameEngine.GeneratedDesktopRuntime2DPackage.Config
name=$Name
displayName=$DisplayName
renderer=null-fallback
scenePackage=runtime/$Name.geindex
...
"@
    ...
    $runtimeConfig = @"
format=GameEngine.GeneratedDesktopRuntime3DPackage.Config
name=$Name
displayName=$DisplayName
