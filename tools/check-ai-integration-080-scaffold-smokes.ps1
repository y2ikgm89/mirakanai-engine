...
foreach ($needle in @(
    ...
    "--require-gameplay-systems",
    "require_gameplay_systems", "mirakana/runtime/gameplay_runtime_scheduler.hpp", "plan_runtime_gameplay_schedule", "mirakana/runtime/world_entity_model.hpp", "plan_runtime_world_entity_lifecycle",
