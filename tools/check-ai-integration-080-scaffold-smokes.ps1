...
try {
    ...
    Assert-ContainsText $desktop2dMain "gameplay_systems_behavior_authoring_diagnostics=" "Desktop 2D scaffold main.cpp"; Assert-ContainsText $desktop2dMain "gameplay_systems_behavior_authoring_readiness_diagnostics=" "Desktop 2D scaffold main.cpp"
