...
foreach ($needle in @(
    ...
    "--require-gameplay-systems",
    "require_gameplay_systems", "mirakana/runtime/gameplay_runtime_scheduler.hpp", "plan_runtime_gameplay_schedule",
    ...
    "gameplay_systems_ready=", "gameplay_runtime_scheduler_command_rows=", "gameplay_runtime_scheduler_budget_limited=", "gameplay_runtime_scheduler_replay_hash=", "gameplay_runtime_scheduler_diagnostics=",
