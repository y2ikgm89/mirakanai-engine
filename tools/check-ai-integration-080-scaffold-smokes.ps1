...
try {
    ...
    $sample2dDesktopMain = Get-AgentSurfaceText "games/sample_2d_desktop_runtime_package/main.cpp"
    Assert-ContainsText $sample2dDesktopMain "--require-sprite-sorting-layer" "sample_2d_desktop_runtime_package main.cpp"
    Assert-ContainsText $sample2dDesktopMain "sprite_sort_layers_applied" "sample_2d_desktop_runtime_package main.cpp"
    Assert-ContainsText $sample2dDesktopMain "sprite_sorted_draws" "sample_2d_desktop_runtime_package main.cpp"
    Assert-ContainsText $sample2dDesktopMain "--require-sprite-9slice-tiled" "sample_2d_desktop_runtime_package main.cpp"
    Assert-ContainsText $sample2dDesktopMain "sprite_9slice_expanded_quads" "sample_2d_desktop_runtime_package main.cpp"
    Assert-ContainsText $sample2dDesktopMain "sprite_tiled_expanded_quads" "sample_2d_desktop_runtime_package main.cpp"
    ...
    Assert-ContainsText $sample2dDesktopMain "--require-2d-physics-runtime-extension" "sample_2d_desktop_runtime_package main.cpp"
    Assert-ContainsText $sample2dDesktopMain "simulate_physics2d_step" "sample_2d_desktop_runtime_package main.cpp"
    Assert-ContainsText $sample2dDesktopMain "2d_physics_runtime_extension_status" "sample_2d_desktop_runtime_package main.cpp"
    Assert-ContainsText $sample2dDesktopMain "2d_physics_runtime_extension_dynamic_vs_dynamic_ccd_claimed" "sample_2d_desktop_runtime_package main.cpp"
    Assert-ContainsText $sample2dDesktopMain "--require-2d-input-device-production-ux" "sample_2d_desktop_runtime_package main.cpp"
    Assert-ContainsText $sample2dDesktopMain "plan_runtime_input_device_production_ux" "sample_2d_desktop_runtime_package main.cpp"
    Assert-ContainsText $sample2dDesktopMain "2d_input_device_production_ux_status" "sample_2d_desktop_runtime_package main.cpp"
    Assert-ContainsText $sample2dDesktopMain "2d_input_device_production_ux_native_handle_access_rows" "sample_2d_desktop_runtime_package main.cpp"
    ...
    if (@($sample2dDesktopManifest.validationRecipes | ForEach-Object { $_.name }) -notcontains "installed-2d-physics-runtime-extension-smoke") {
        Write-Error "sample_2d_desktop_runtime_package manifest validationRecipes missing installed-2d-physics-runtime-extension-smoke"
    }
    ...
    Assert-ContainsText $repositoryGamesCmake "--require-2d-physics-runtime-extension" "games/CMakeLists.txt sample_2d_desktop_runtime_package smoke args"
    Assert-ContainsText $repositoryGamesCmake "--require-2d-input-device-production-ux" "games/CMakeLists.txt sample_2d_desktop_runtime_package smoke args"
    ...
    Assert-ContainsText $validateInstalledRuntimeScript "2d_physics_runtime_extension_status" "Installed desktop runtime validation"
    Assert-ContainsText $validateInstalledRuntimeScript "2d_physics_runtime_extension_dynamic_vs_dynamic_ccd_claimed" "Installed desktop runtime validation"
...
try {
    ...
    if ($desktop2dManifest.aiWorkflow.validationRemediationRecipes.capabilityId -ne "ai-validation-remediation-recipes-v1") {
        Write-Error "Desktop runtime 2D package scaffold manifest must carry ai-validation-remediation-recipes-v1"
    }
    $desktop2dValidationRemediationText = $desktop2dManifest.aiWorkflow.validationRemediationRecipes | ConvertTo-Json -Depth 40
    ...
    Assert-ContainsText $desktop2dMain "mirakana/runtime/networking_foundation.hpp" "Desktop 2D scaffold main.cpp"
    ...
    Assert-ContainsText $desktop2dMain "--require-networking-foundation-policy" "Desktop 2D scaffold main.cpp"
    ...
    Assert-ContainsText $desktop2dMain "gameplay_systems_navigation_plan_status=" "Desktop 2D scaffold main.cpp"; Assert-ContainsText $desktop2dMain "gameplay_systems_perception_readiness_status=" "Desktop 2D scaffold main.cpp"; Assert-ContainsText $desktop2dMain "gameplay_systems_perception_readiness_diagnostic=" "Desktop 2D scaffold main.cpp"
    Assert-ContainsText $desktop2dMain "gameplay_systems_behavior_status=" "Desktop 2D scaffold main.cpp"
    Assert-ContainsText $desktop2dMain "gameplay_systems_behavior_authoring_ready=" "Desktop 2D scaffold main.cpp"; Assert-ContainsText $desktop2dMain "gameplay_systems_behavior_authoring_readiness_status=" "Desktop 2D scaffold main.cpp"
    Assert-ContainsText $desktop2dMain "gameplay_systems_behavior_authoring_diagnostics=" "Desktop 2D scaffold main.cpp"; Assert-ContainsText $desktop2dMain "gameplay_systems_behavior_authoring_readiness_diagnostics=" "Desktop 2D scaffold main.cpp"; Assert-ContainsText $desktop2dMain "gameplay_systems_perception_stable_primary_target_ready=" "Desktop 2D scaffold main.cpp"; Assert-ContainsText $desktop2dMain "gameplay_systems_perception_blackboard_projection_ready=" "Desktop 2D scaffold main.cpp"
    Assert-ContainsText $desktop2dMain "gameplay_systems_behavior_authoring_trace_nodes=" "Desktop 2D scaffold main.cpp"; Assert-ContainsText $desktop2dMain "gameplay_systems_behavior_authoring_deterministic_trace_ready=" "Desktop 2D scaffold main.cpp"
...
foreach ($nativeShellMainNeedle in @("win32_first_party_editor_host.hpp", "editor_shell_status=ready", "editor_shell_ui=first_party", "editor_shell_backend=", "editor_shell_imgui=0", "editor_shell_panels=", "editor_shell_docking_status=", "editor_shell_dock_tab_headers=", "editor_shell_dock_split_gutters=", "editor_shell_dock_active_panels=", "editor_shell_dock_focusable_controls=", "editor_shell_sdl3=0", "editor_shell_material_preview_status=", "editor_shell_material_preview_native_handles_exposed=", "editor_shell_ime_status=", "editor_shell_ime_caret_rect_rows=", "editor_shell_ime_surrounding_text_rows=", "editor_shell_ime_native_handles_exposed=", "editor_shell_renderer_boxes_submitted=", "editor_shell_renderer_text_runs_available=")) { Assert-ContainsText $editorMainText $nativeShellMainNeedle "native editor shell main" }
...
try {
    ...
    if ($desktop3dManifest.aiWorkflow.validationRemediationRecipes.capabilityId -ne "ai-validation-remediation-recipes-v1") {
        Write-Error "Desktop runtime 3D package scaffold manifest must carry ai-validation-remediation-recipes-v1"
    }
    $desktop3dValidationRemediationText = $desktop3dManifest.aiWorkflow.validationRemediationRecipes | ConvertTo-Json -Depth 40
...
foreach ($needle in @(
    ...
    "--require-gameplay-systems",
    "require_gameplay_systems", "mirakana/runtime/gameplay_runtime_scheduler.hpp", "plan_runtime_gameplay_schedule", "mirakana/runtime/world_entity_model.hpp", "plan_runtime_world_entity_lifecycle", "mirakana/runtime/addressable_content_streaming.hpp", "plan_runtime_addressable_content_streaming",
    "gameplay_systems_status=", "gameplay_runtime_scheduler_status=", "gameplay_runtime_scheduler_ready=", "gameplay_runtime_scheduler_available_steps=", "gameplay_runtime_scheduler_steps=", "gameplay_runtime_scheduler_system_rows=",
    "gameplay_systems_ready=", "gameplay_runtime_scheduler_command_rows=", "gameplay_runtime_scheduler_budget_limited=", "gameplay_runtime_scheduler_replay_hash=", "gameplay_runtime_scheduler_diagnostics=", "world_entity_model_status=", "world_entity_model_ready=", "world_entity_model_entities=", "world_entity_model_components=", "world_entity_model_region_ownership_rows=", "world_entity_model_lifecycle_rows=", "world_entity_model_persistence_rows=", "world_entity_model_streaming_region_rows=", "world_entity_model_spawn_rows=", "world_entity_model_move_rows=", "world_entity_model_despawn_rows=", "world_entity_model_duplicate_entity_diagnostics=", "world_entity_model_bridge_rejection_status=", "world_entity_model_bridge_rejection_diagnostics=", "world_entity_model_bridge_rejection_persistence_rows=", "world_entity_model_bridge_rejection_streaming_region_rows=", "world_entity_model_bridge_rejection_streaming_diagnostics_present=", "world_entity_model_bridge_rejection_fail_closed=", "world_entity_model_diagnostics=",
    "addressable_content_status=", "addressable_content_ready=", "addressable_content_address_rows=", "addressable_content_dependency_rows=", "addressable_content_load_rows=", "addressable_content_release_rows=", "addressable_content_refcount_rows=", "addressable_content_resident_bytes=", "addressable_content_resident_budget_bytes=", "addressable_content_budget_rejection_status=", "addressable_content_budget_rejection_diagnostics=", "addressable_content_package_io=", "addressable_content_async_execution=", "addressable_content_committed=", "addressable_content_diagnostics=",
    ...
    "gameplay_systems_character_dynamics_status=", "gameplay_systems_character_dynamics_step_ups=",
    "gameplay_systems_character_dynamics_walkable_slope_rows=", "gameplay_systems_character_dynamics_ground_probes=",
    "gameplay_systems_character_dynamics_replay_changed=", "gameplay_systems_character_dynamics_diagnostics=",
...
try {
    ...
    $createGameRecipeDesignPath = Join-Path $createGameRecipeRoot "designs/orchestrated-2d.game_design.json"
    Set-Content -LiteralPath $createGameRecipeDesignPath -Value (@{
            schemaVersion = 1
            capabilityId = "ai-game-design-spec-v1"
            designId = "orchestrated-2d"
            gameplayFamily = "2d-desktop-runtime-package"
            template = "DesktopRuntime2DPackage"
            camera = @{
                mode = "fixed-2d"
                primary = "orchestrated-camera"
            }
            inputMap = @(@{
                    action = "move"
                    defaultBinding = "Left Arrow"
                    purpose = "Move through the generated deterministic package smoke."
                })
            coreLoop = @{
                objective = "Create a reviewed generated 2D package scaffold from a design spec."
                playerActions = @("move", "restart-smoke")
                feedback = "Package-visible counters prove the generated 2D scaffold."
                winState = "Selected validation recipes pass."
                failState = "Missing package files or unsafe claims fail validation."
                restart = "Rerun deterministic package smoke recipes."
            }
            sceneList = @(@{
                    id = "playable-scene"
                    kind = "scene"
                    path = "runtime/assets/2d/playable.scene"
                    purpose = "Cooked scene generated by the reviewed scaffold."
                })
            assetRequests = @(@{
                    id = "player-sprite"
                    kind = "sprite-atlas"
                    purpose = "Reviewed generated placeholder sprite atlas for package proof."
                    delivery = "reviewed-source-authoring"
                })
            systems = @("scene-rendering", "runtime-ui", "physics-2d")
            packageTargets = @("desktop-game-runtime", "desktop-runtime-release")
            validationRecipeIds = @("desktop-game-runtime", "desktop-runtime-release-target", "installed-2d-package-smoke")
            qualityGates = @(@{
                    id = "package-loads"
                    evidence = "The generated package scaffold declares manifest-derived runtime package files."
        ...
        } | ConvertTo-Json -Depth 20) -NoNewline

    $createGameRecipeTool = Resolve-RequiredAgentPath "tools/create-game-recipe.ps1"
    $createGameRecipeDryRun = & $createGameRecipeTool `
        -RepositoryRoot $createGameRecipeRoot `
        -GameName "orchestrated_2d" `
        -DesignSpecPath "designs/orchestrated-2d.game_design.json" `
        -Mode DryRun | ConvertFrom-Json
    if ($createGameRecipeDryRun.status -ne "planned") {
        Write-Error "create-game-recipe dry-run must report planned status"
    }
    if (@($createGameRecipeDryRun.changedFiles).Count -ne 0) {
        Write-Error "create-game-recipe dry-run must not report changedFiles"
    }
    foreach ($relativePath in @(
            "games/orchestrated_2d/game.agent.json",
            "games/orchestrated_2d/main.cpp",
            "games/CMakeLists.txt"
        )) {
        if (@($createGameRecipeDryRun.plannedFiles) -notcontains $relativePath) {
            Write-Error "create-game-recipe dry-run plannedFiles missing $relativePath"
        }
    }
    if (Test-Path -LiteralPath (Join-Path $createGameRecipeRoot "games/orchestrated_2d")) {
        Write-Error "create-game-recipe dry-run must not create the generated game directory"
    }

    $createGameRecipeApply = & $createGameRecipeTool `
        -RepositoryRoot $createGameRecipeRoot `
        -GameName "orchestrated_2d" `
        -DesignSpecPath "designs/orchestrated-2d.game_design.json" `
        -Mode Apply | ConvertFrom-Json
    if ($createGameRecipeApply.status -ne "applied") {
        Write-Error "create-game-recipe apply must report applied status"
    }
    foreach ($relativePath in @(
            "games/orchestrated_2d/game.agent.json",
            "games/orchestrated_2d/main.cpp",
        ...
        if (@($createGameRecipeApply.changedFiles) -notcontains $relativePath) {
            Write-Error "create-game-recipe apply changedFiles missing $relativePath"
        }
    }
    $createGameRecipeManifest = Get-Content -LiteralPath (Join-Path $createGameRecipeRoot "games/orchestrated_2d/game.agent.json") -Raw | ConvertFrom-Json
    ...
    if ($createGameRecipeManifest.aiWorkflow.validationRemediationRecipes.capabilityId -ne "ai-validation-remediation-recipes-v1") {
        Write-Error "create-game-recipe apply must preserve the generated validation remediation recipes"
    }
    ...
    $createGameRecipeCmake = Get-Content -LiteralPath (Join-Path $createGameRecipeRoot "games/CMakeLists.txt") -Raw
    Assert-ContainsText $createGameRecipeCmake "MK_add_desktop_runtime_game(orchestrated_2d" "create-game-recipe apply CMake"
    $createGameRecipe3dDesign = @{ schemaVersion = 1; capabilityId = "ai-game-design-spec-v1"; designId = "orchestrated-3d"; gameplayFamily = "3d-playable-desktop-package"; template = "DesktopRuntime3DPackage"; camera = @{ mode = "perspective-3d"; primary = "orchestrated-3d-camera" }; inputMap = @(@{ action = "move"; defaultBinding = "WASD"; purpose = "Move through the generated deterministic 3D package smoke." }); coreLoop = @{ objective = "Create a reviewed generated 3D package scaffold from a design spec."; playerActions = @("move", "look", "restart-smoke"); feedback = "Package-visible renderer and gameplay counters prove the generated 3D scaffold."; winState = "Selected 3D validation recipes pass."; failState = "Missing package files or unsafe claims fail validation."; restart = "Rerun deterministic 3D package smoke recipes." }; sceneList = @(@{ id = "playable-scene"; kind = "scene"; path = "runtime/assets/3d/packaged_scene.scene"; purpose = "Cooked scene generated by the reviewed 3D scaffold." }); assetRequests = @(@{ id = "static-mesh"; kind = "mesh"; purpose = "Reviewed generated placeholder mesh for package proof."; delivery = "reviewed-source-authoring" }); systems = @("scene-rendering", "runtime-ui", "physics-3d"); packageTargets = @("desktop-game-runtime", "desktop-runtime-release"); validationRecipeIds = @("desktop-game-runtime", "desktop-runtime-release-target", "installed-d3d12-3d-package-smoke"); qualityGates = @(@{ id = "package-loads"; evidence = "The generated 3D package scaffold declares manifest-derived runtime package files."; recipeIds = @("desktop-runtime-release-target", "installed-d3d12-3d-package-smoke") }); unsupportedClaims = @("engine-internal-edits", "native-handles", "middleware-contracts", "unreviewed-external-assets", "arbitrary-shell", "broad-commercial-quality", "runtime-source-parsing", "renderer-rhi-residency", "metal-readiness") }
    Set-Content -LiteralPath (Join-Path $createGameRecipeRoot "designs/orchestrated-3d.game_design.json") -Value ($createGameRecipe3dDesign | ConvertTo-Json -Depth 20) -NoNewline
    $createGameRecipe3dDryRun = & $createGameRecipeTool -RepositoryRoot $createGameRecipeRoot -GameName "orchestrated_3d" -DesignSpecPath "designs/orchestrated-3d.game_design.json" -Mode DryRun | ConvertFrom-Json
    if ($createGameRecipe3dDryRun.status -ne "planned") { Write-Error "create-game-recipe 3D dry-run must report planned status" }
    foreach ($relativePath in @(
            "games/orchestrated_3d/game.agent.json",
            "games/orchestrated_3d/runtime/assets/3d/packaged_scene.scene",
            "games/orchestrated_3d/shaders/runtime_scene.hlsl"
        )) {
        if (@($createGameRecipe3dDryRun.plannedFiles) -notcontains $relativePath) {
            Write-Error "create-game-recipe 3D dry-run plannedFiles missing $relativePath"
        }
    }
    $createGameRecipe3dApply = & $createGameRecipeTool -RepositoryRoot $createGameRecipeRoot -GameName "orchestrated_3d" -DesignSpecPath "designs/orchestrated-3d.game_design.json" -Mode Apply | ConvertFrom-Json
    if ($createGameRecipe3dApply.status -ne "applied") { Write-Error "create-game-recipe 3D apply must report applied status" }
    if (@($createGameRecipe3dApply.changedFiles) -notcontains "games/orchestrated_3d/shaders/runtime_scene.hlsl") {
        Write-Error "create-game-recipe 3D apply changedFiles missing runtime_scene.hlsl"
    }
    ...
    if ($createGameRecipe3dManifest.aiWorkflow.validationRemediationRecipes.capabilityId -ne "ai-validation-remediation-recipes-v1") { Write-Error "create-game-recipe 3D apply must preserve the generated validation remediation recipes" }
    ...
    Remove-ScaffoldCheckRoot $createGameRecipeRoot
}
