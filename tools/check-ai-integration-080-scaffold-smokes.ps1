...
foreach ($nativeShellMainNeedle in @("win32_first_party_editor_host.hpp", "editor_shell_status=ready", "editor_shell_ui=first_party", "editor_shell_backend=", "editor_shell_imgui=0", "editor_shell_panels=", "editor_shell_docking_status=", "editor_shell_dock_tab_headers=", "editor_shell_dock_split_gutters=", "editor_shell_dock_active_panels=", "editor_shell_dock_focusable_controls=", "editor_shell_sdl3=0", "editor_shell_material_preview_status=", "editor_shell_material_preview_native_handles_exposed=", "editor_shell_ime_status=", "editor_shell_ime_caret_rect_rows=", "editor_shell_ime_surrounding_text_rows=", "editor_shell_ime_native_handles_exposed=", "editor_ime_parity_status=", "editor_ime_windows_tsf_status=", "editor_ime_macos_status=", "editor_ime_linux_ibus_status=", "editor_ime_linux_fcitx_status=", "editor_ime_android_status=", "editor_ime_ios_status=", "editor_ime_native_handles_exposed=", "editor_shell_renderer_boxes_submitted=", "editor_shell_renderer_text_runs_available=")) { Assert-ContainsText $editorMainText $nativeShellMainNeedle "native editor shell main" }
foreach ($nativeShellMainNeedle in @("editor_ui_performance_budget_status=", "editor_ui_performance_layout_us_p95=", "editor_ui_performance_document_build_us_p95=", "editor_ui_performance_renderer_submission_us_p95=", "editor_ui_performance_text_runs=", "editor_ui_performance_renderer_boxes=", "editor_ui_performance_visible_texture_composites=", "editor_ui_performance_memory_high_water_bytes=", "editor_ui_performance_budget_violations=", "editor_ui_performance_diagnostics=", "editor_ui_performance_broad_optimization_claimed=")) { Assert-ContainsText $editorMainText $nativeShellMainNeedle "native editor shell performance budget main" }
foreach ($nativeShellMainNeedle in @("first_party_editor_excellence_status=", "first_party_editor_excellence=", "first_party_editor_excellence_windows_d3d12=", "first_party_editor_excellence_vulkan=", "first_party_editor_excellence_metal=", "first_party_editor_excellence_cross_platform=", "first_party_editor_excellence_text_parity=", "first_party_editor_excellence_accessibility_parity=", "first_party_editor_excellence_broad_optimization_claimed=", "first_party_editor_excellence_native_handles_exposed=")) { Assert-ContainsText $editorMainText $nativeShellMainNeedle "native editor shell excellence aggregate main" }
