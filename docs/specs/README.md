...
| **Retained policy design record** | [`2026-04-26-toolchain-dependency-policy-design.md`](2026-04-26-toolchain-dependency-policy-design.md) | Default build stays third-party-free; `vcpkg.json` baseline; dependency-free `desktop-editor` lane plus optional manifest features; `check-dependency-policy` expectations. |
...
| **Retained analysis record** | [`2026-06-01-engine-performance-optimization-foundation-v1.md`](2026-06-01-engine-performance-optimization-foundation-v1.md) | CPU, memory, job-system, GPU/RHI, and optional CUDA/HIP optimization guidance grounded in official vendor docs and recommended systems papers. |
| **Retained policy design record** | [`2026-06-28-codebase-memory-local-ai-helper-v1.md`](2026-06-28-codebase-memory-local-ai-helper-v1.md) | Developer-local `codebase-memory-mcp` policy: full indexing, local artifact boundaries, forbidden ADR/secrets uses, and verified external runtime edge ingestion. |
