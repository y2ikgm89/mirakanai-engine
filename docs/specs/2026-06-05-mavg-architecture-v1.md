...
- Keep GPU-generated count buffers, compute-generated indirect buffers, UAV-to-indirect synchronization, and public buffer-state tracking fail-closed until explicit follow-up plans add feature gates and synchronization proof.

Future responsibilities:

- Actual compute culling dispatch and command/count buffer writes.
- D3D12 compute-written argument/count buffer synchronization.
