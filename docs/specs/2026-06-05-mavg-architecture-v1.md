...
- Broader sustained background/page package streaming workers beyond the joined engine-owned proof, async overlap/performance evidence, caller-owned RHI resource-destination DirectStorage IO, GPU decompression, and GPU memory pressure integration.
