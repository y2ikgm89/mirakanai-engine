...
- Broader sustained background/page package streaming workers beyond the joined engine-owned proof, async overlap/performance evidence, partial `.mavgpayload` byte-range page loading/schema, automatic eviction policy, and GPU memory pressure integration.
