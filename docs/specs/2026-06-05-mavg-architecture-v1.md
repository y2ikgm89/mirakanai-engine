...
- Broader sustained background/page package streaming workers beyond the joined engine-owned proof, async overlap/performance evidence, DirectStorage native file IO execution, LRU/recency/frequency eviction policy, and GPU memory pressure integration.
