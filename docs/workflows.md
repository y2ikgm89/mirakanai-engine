...
- Treat `docs/superpowers/master-plans/2026-05-03-production-completion-master-plan-v1.md` as a lightweight index; load only the needed `docs/superpowers/master-plans/production-completion-v1/*.md` chapter, and load `99-historical-verdict-archive.md` only for static-check history or migration audits.
