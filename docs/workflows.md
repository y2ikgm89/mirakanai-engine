...
- Windows PR lane: `tools/validate.ps1 -SkipStaticChecks` after `Agent Static Guards` covers `tools/validate.ps1 -StaticOnly`; local/default full validation remains `tools/validate.ps1`
