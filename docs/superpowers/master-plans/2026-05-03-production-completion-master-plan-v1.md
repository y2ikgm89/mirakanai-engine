...
- Current active plan: no child plan is selected. [Renderer Postprocess Tone Mapping Evidence v1](../plans/2026-05-29-renderer-postprocess-tone-mapping-evidence-v1.md) completed through PR #298 after Renderer Backend Parity Metal Apple Evidence v1 completed through PR #296 and Renderer Backend Parity Metal Apple Closeout v1 completed through PR #297.
