...
- Current active plan: [Physics Navigation Commercial Coverage v1](../plans/2026-05-29-physics-navigation-commercial-coverage-v1.md) is selected after [Reviewed Importers Codecs And Shader Generation v1](../plans/2026-05-27-reviewed-importers-codecs-shader-generation-v1.md) completed selected importer/codec/shader-generation evidence.
- Current manifest state: `unsupportedProductionGaps = []`; `recommendedNextPlan.id = physics-navigation-commercial-coverage-v1` marks the selected post-1.0 physics/navigation commercial coverage slice. Historical zero-gap closeout evidence remains discoverable through the retained plan registry and archive.
