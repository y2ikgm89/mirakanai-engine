...
- Current active plan: no child plan is selected. `engine/agent/manifest.json.aiOperableProductionLoop.currentActivePlan` points back to this master index after [Physics Navigation Commercial Coverage v1](../plans/2026-05-29-physics-navigation-commercial-coverage-v1.md) completed stricter optional Jolt/Recast/Detour-class adapter evidence gates.
