...
- Current active plan: [First-Party Desktop Platform And SDL3 Removal v1](../plans/2026-05-27-first-party-desktop-platform-sdl3-removal-v1.md), a long-running clean-break platform milestone selected by operator direction on 2026-05-27. [Reviewed Importers Codecs And Shader Generation v1](../plans/2026-05-27-reviewed-importers-codecs-shader-generation-v1.md) is paused and must be resumed only through an explicit manifest/registry switch.
- Current manifest state: `unsupportedProductionGaps = []`; `recommendedNextPlan.id = first-party-desktop-platform-sdl3-removal-v1` selects the Windows-first native desktop backend and SDL3 deletion milestone. Historical zero-gap closeout evidence remains discoverable through the retained plan registry and archive.
