...
No child plan is currently selected. [First-Party Desktop Platform And SDL3 Removal v1](../../plans/2026-05-27-first-party-desktop-platform-sdl3-removal-v1.md) completed the Windows-first clean-break desktop platform milestone and returned the manifest-led selection pointer to `recommendedNextPlan.id = next-production-gap-selection` while `unsupportedProductionGaps = []` remains unchanged. [Engine 1.0 Gap Matrix v1](../../plans/2026-05-26-engine-1-0-gap-matrix-v1.md), [Renderer Production VFX Profiling Host Gate v1](../../plans/2026-05-26-renderer-production-vfx-profiling-host-gate-v1.md), [Engine General Production Quality Expansion v1](../../plans/2026-05-26-engine-general-production-quality-expansion-v1.md), [Renderer Production Quality And Backend Parity v1](../../plans/2026-05-27-renderer-production-quality-backend-parity-v1.md), and [Runtime UI Text Platform Stack v1](../../plans/2026-05-27-runtime-ui-text-platform-stack-v1.md) remain completed evidence. [Reviewed Importers Codecs And Shader Generation v1](../../plans/2026-05-27-reviewed-importers-codecs-shader-generation-v1.md) is paused and can resume only through an explicit manifest/registry switch.
...
4. Select the next production child explicitly before implementation; likely candidates include resuming `reviewed-importers-codecs-shader-generation-v1` or choosing another clean-break broad-production row, but the manifest must be updated first.
