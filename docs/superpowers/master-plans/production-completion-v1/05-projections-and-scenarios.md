...
- **Asset/import:** keep Khronos glTF/KTX2/Basis validation, optional codec/importer dependencies, shader compiler invocation, and package mutation as reviewed gates. A broad import claim needs explicit source roots, importer ids, selected extensions, package rows, license/provenance/hash evidence, validator/dependency/legal rows, exact `vcpkg.ktx-software` dependency evidence before KTX2/Basis readiness, exact `toolchain.dxc` plus `toolchain.spirv-tools` dependency evidence before shader rows are ready, offline shader command review rows, host gates, and execution-readiness rows that separate reviewed execution from dependency-gated, host-gated, package-mutation, and unsupported-claim evidence before promotion.
...
The active child plan is [Reviewed Importers Codecs And Shader Generation v1](../../plans/2026-05-27-reviewed-importers-codecs-shader-generation-v1.md). [First-Party Desktop Platform And SDL3 Removal v1](../../plans/2026-05-27-first-party-desktop-platform-sdl3-removal-v1.md) completed the Windows-first clean-break desktop platform milestone, and the manifest-led selection pointer now uses `recommendedNextPlan.id = reviewed-importers-codecs-shader-generation-v1` while `unsupportedProductionGaps = []` remains unchanged. [Engine 1.0 Gap Matrix v1](../../plans/2026-05-26-engine-1-0-gap-matrix-v1.md), [Renderer Production VFX Profiling Host Gate v1](../../plans/2026-05-26-renderer-production-vfx-profiling-host-gate-v1.md), [Engine General Production Quality Expansion v1](../../plans/2026-05-26-engine-general-production-quality-expansion-v1.md), [Renderer Production Quality And Backend Parity v1](../../plans/2026-05-27-renderer-production-quality-backend-parity-v1.md), [Runtime UI Text Platform Stack v1](../../plans/2026-05-27-runtime-ui-text-platform-stack-v1.md), and [First-Party Desktop Platform And SDL3 Removal v1](../../plans/2026-05-27-first-party-desktop-platform-sdl3-removal-v1.md) remain completed evidence.
...
4. Execute the active `reviewed-importers-codecs-shader-generation-v1` child one candidate at a time, and do not switch to another clean-break broad-production row until this child is implemented, host-gated with evidence, or explicitly paused through a manifest/registry update.
