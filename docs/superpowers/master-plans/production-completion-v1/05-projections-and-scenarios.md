...
| AI-authored games | `ai-game-design-spec-v1`, `ai-game-generation-orchestrator-v1`, `ai-safe-content-mutation-ledger-v1`, `ai-generated-game-playtest-loop-v1`, `ai-generated-game-quality-rubric-v1`, `ai-engine-capability-handoff-v1` | Design-spec to game-owned content flow, mutation ledger, validation recipes, remediation rows, quality-rubric gates, and no engine-internal edits. |
