...
2. Select the next `renderer-backend-parity-v1` Apple/Metal implementation or evidence step only through an explicit dated plan; Windows/Vulkan proof must not promote Metal readiness.
