...
| 3D physics/collision queries | `covered-foundation` + `advanced-track` | `physics-collision-query-v1`; `physics-joints-foundation-v1`; `physics-constraints-and-joints-v1`; `physics-vehicles-and-kinematics-v1` | Deterministic query, distance-joint, distance/fixed/linear-axis constraint, and value-only kinematic motion foundations exist; public vehicle simulation APIs and richer body interaction remain post-1.0 follow-up work. |
...
| Advanced 3D physics | `advanced-track` | `physics-constraints-and-joints-v1`; `physics-vehicles-and-kinematics-v1`; optional middleware adapter plans | Constraint and kinematic first-slice evidence exists; public vehicles, ragdoll-like systems, and optional middleware adapters still need first-party contracts or opaque adapters, deterministic tests, and legal/dependency updates. |
