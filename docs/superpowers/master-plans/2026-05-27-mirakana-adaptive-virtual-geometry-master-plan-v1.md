...
**Latest audit:** 2026-07-02. This audit keeps the plan as the long-range master roadmap, reconciles completed MAVG child plans through MAVG DirectStorage GDeflate Execution Evidence v1 PR #944 / merge commit `08828f48db9a93f8cecc110dac78be2a412de5de`, records MAVG DirectStorage Zstd Preview Review v1 as a value-only public-preview review gate, and preserves fail-closed non-claims for GPU DirectStorage destination execution, GDeflate/GPU decompression execution, DirectStorage 1.4/Zstd execution, GACL execution, benchmark superiority, Metal mesh LOD readiness without Apple-host object/mesh shader execution, deformation/ray tracing backend execution readiness, broad CPU/GPU/memory optimization readiness, broad MAVG/backend/renderer/environment/commercial readiness, and Nanite compatibility/equivalence/superiority product claims.
...
MAVG DirectStorage GPU Destination Execution Evidence v1 (`mavg-directstorage-gpu-destination-execution-evidence-v1`) adds `mavg_directstorage_gpu_destination_execution.hpp`, `RuntimeMavgDirectStorageGpuDestinationExecutionRow`, `RuntimeMavgDirectStorageGpuDestinationExecutionResult`, `evaluate_runtime_mavg_directstorage_gpu_destination_execution_evidence`, `GameEngine.MavgDirectStorageGpuDestinationExecutionEvidence.v1`, and `tools/validate-mavg-directstorage-gpu-destination-execution.ps1`. The value-only API accepts exact reviewed DirectStorage 1.3 GPU destination rows with `EnqueueRequests`, D3D12 fence synchronization, `D3D12_RESOURCE_STATE_COMMON`, completed request/status/readback/package-output proof, and retained artifact hashes. Default retained validation remains host-gated with `mavg_directstorage_gpu_destination_execution_ready=0`, `mavg_directstorage_multiple_subresources_range_execution_ready=0`, `mavg_directstorage_gdeflate_execution_ready=0`, `mavg_directstorage_zstd_preview_ready=0`, `mavg_directstorage_native_handles_exposed=0`, `mavg_package_visible_backend_readiness_ready=0`, `mavg_directstorage_performance_ready=0`, `mavg_broad_cpu_gpu_memory_optimization_ready=0`, `mavg_nanite_compatible=0`, `mavg_nanite_equivalent=0`, `mavg_nanite_superior=0`, and `mavg_external_engine_compatibility=0` until retained host artifacts exist. DirectStorage 1.4/Zstd preview, GDeflate execution, performance readiness, Unity/Unreal/Godot compatibility, and Nanite compatibility/equivalence/superiority remain non-claims.

MAVG DirectStorage GDeflate Execution Evidence v1 (`mavg-directstorage-gdeflate-execution-evidence-v1`) adds `mavg_directstorage_gdeflate_execution.hpp`, `RuntimeMavgDirectStorageGDeflateExecutionRow`, `RuntimeMavgDirectStorageGDeflateExecutionResult`, `evaluate_runtime_mavg_directstorage_gdeflate_execution_evidence`, `GameEngine.MavgDirectStorageGDeflateExecutionEvidence.v1`, and `tools/validate-mavg-directstorage-gdeflate-execution.ps1`. The value-only API accepts reviewed DirectStorage 1.1 GDeflate plus DirectStorage 1.3 GPU destination rows only when request options, `GetCompressionSupport` GPU optimized or GPU fallback evidence, compute/copy queue support, GPU decompression staging, `EnqueueRequests`, D3D12 fence synchronization, `D3D12_RESOURCE_STATE_COMMON`, completed request/status/readback/package-output proof, and retained artifact hashes are present. Default retained validation remains host-gated with `mavg_directstorage_gdeflate_execution_ready=0`, `mavg_directstorage_gpu_destination_execution_ready=0`, `mavg_directstorage_multiple_subresources_range_execution_ready=0`, `mavg_directstorage_zstd_preview_ready=0`, `mavg_directstorage_native_handles_exposed=0`, `mavg_package_visible_backend_readiness_ready=0`, `mavg_directstorage_performance_ready=0`, `mavg_broad_cpu_gpu_memory_optimization_ready=0`, `mavg_nanite_compatible=0`, `mavg_nanite_equivalent=0`, `mavg_nanite_superior=0`, and `mavg_external_engine_compatibility=0` until retained host artifacts exist. CPU fallback is not GPU execution evidence, and DirectStorage 1.4/Zstd preview, performance readiness, package-visible backend readiness, Unity/Unreal/Godot compatibility, and Nanite compatibility/equivalence/superiority remain non-claims.

MAVG DirectStorage Zstd Preview Review v1 (`mavg-directstorage-zstd-preview-review-v1`) adds `mavg_directstorage_zstd_preview_review.hpp`, `RuntimeMavgDirectStorageZstdPreviewRow`, `RuntimeMavgDirectStorageZstdPreviewResult`, `evaluate_runtime_mavg_directstorage_zstd_preview_review`, `GameEngine.MavgDirectStorageZstdPreviewReview.v1`, and `tools/validate-mavg-directstorage-zstd-preview-review.ps1`. It records official Microsoft DirectStorage 1.4 public-preview Zstd, GACL shuffle/postprocess scope, D3D12 CreatorID, explicitly authored Zstd/GACL asset requirements, explicit API usage requirements, and preview known issues while emitting `mavg_directstorage_zstd_preview_review_ready=1`, `mavg_directstorage_zstd_preview_selected=1`, `mavg_directstorage_zstd_preview_ready=0`, `mavg_directstorage_zstd_execution_ready=0`, `mavg_directstorage_gacl_pipeline_ready=0`, `mavg_directstorage_native_handles_exposed=0`, `mavg_package_visible_backend_readiness_ready=0`, `mavg_directstorage_performance_ready=0`, `mavg_broad_cpu_gpu_memory_optimization_ready=0`, `mavg_nanite_compatible=0`, `mavg_nanite_equivalent=0`, `mavg_nanite_superior=0`, and `mavg_external_engine_compatibility=0`.

The official-source split is exact: Microsoft DirectStorage 1.1 introduced GDeflate GPU decompression, DirectStorage 1.3 introduced `EnqueueRequests` and `DSTORAGE_DESTINATION_MULTIPLE_SUBRESOURCES_RANGE`, and DirectStorage 1.4/Zstd/GACL is a public-preview path that requires explicitly authored Zstd/GACL assets plus explicit API usage. This is a first-party value-only DirectStorage/GDeflate/Zstd preview review evidence gate, not DirectStorage execution, asset conditioning execution, GPU decompression execution, package-visible MAVG backend readiness, performance proof, or broad optimization. It does not claim Unity, Unreal, Godot, or Nanite compatibility, parity, equivalence, replacement, imitation, endorsement, or superiority, and it does not import or reuse their projects, schemas, code, samples, assets, UI, shaders, trademarks, or private formats.
...
MAVG DirectStorage GPU Destination Execution Evidence v1 (`mavg-directstorage-gpu-destination-execution-evidence-v1`) narrows the former GPU destination execution unknown into a first-party value-only host-evidence gate. It adds `mavg_directstorage_gpu_destination_execution.hpp`, `RuntimeMavgDirectStorageGpuDestinationExecutionRow`, `RuntimeMavgDirectStorageGpuDestinationExecutionResult`, `evaluate_runtime_mavg_directstorage_gpu_destination_execution_evidence`, `GameEngine.MavgDirectStorageGpuDestinationExecutionEvidence.v1`, and `tools/validate-mavg-directstorage-gpu-destination-execution.ps1`. Default evidence remains `mavg_directstorage_gpu_destination_execution_ready=0`, `mavg_directstorage_multiple_subresources_range_execution_ready=0`, `mavg_directstorage_gdeflate_execution_ready=0`, `mavg_directstorage_zstd_preview_ready=0`, `mavg_directstorage_native_handles_exposed=0`, `mavg_package_visible_backend_readiness_ready=0`, `mavg_directstorage_performance_ready=0`, `mavg_broad_cpu_gpu_memory_optimization_ready=0`, `mavg_nanite_compatible=0`, `mavg_nanite_equivalent=0`, `mavg_nanite_superior=0`, and `mavg_external_engine_compatibility=0` until exact retained host artifacts prove DirectStorage 1.3 `EnqueueRequests`, D3D12 fence synchronization, `D3D12_RESOURCE_STATE_COMMON`, status/readback/package-output rows, and retained artifact hashes. DirectStorage 1.4/Zstd preview, GDeflate execution, performance readiness, package-visible backend readiness, Unity/Unreal/Godot compatibility, and Nanite compatibility/equivalence/superiority remain non-claims.
