...
- No GPU cluster traversal or written GPU visibility buffer beyond current value-only visible cluster packet/layout rows and allocation-only `MK_runtime_rhi` visibility-buffer resource rows.
