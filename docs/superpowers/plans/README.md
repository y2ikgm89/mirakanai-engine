...
| Status | Plan | Notes |
| --- | --- | --- |
| Active milestone (`currentActivePlan`) | [General Purpose Game Production v1](2026-05-25-general-purpose-game-production-v1.md) | Selected post-foundation production track; Phases 1-2 implement reusable gameplay runtime scheduling and world/entity ownership, and the remaining candidates cover addressable content streaming, authoring workflows, runtime UI workbench, genre packs, network replication, and rendering/VFX/profiling surfaces. |
