...
| Status | Plan | Notes |
| --- | --- | --- |
| Active milestone (`currentActivePlan`) | [Native Win32 Editor Shell v1](2026-05-30-native-win32-editor-shell-v1.md) | Selected clean-break milestone to restore a launchable `MK_editor` as a Windows-native Win32 + Dear ImGui + Direct3D 12 shell after SDL3 removal. Phase 1 dependency/legal/policy gate completed through PR #316 / merge commit `b1a55f6d52d86bcb4cfde8134592b23fff5bf4c5`; Phase 2 launch skeleton completed through PR #317 / merge commit `e96d6b477b0637c539bde1a743800341580a3606`; Phase 3/4 native host and smoke lane completed through PR #318 / merge commit `4611f7165f4423a242e299d17f9f022c0f241a0b`; Phase 5 core-backed panels completed through PR #319 / merge commit `61674e0f05379146894425f7c46d3306afd38f55`; Phase 6 Win32 file-dialog, clipboard, and reviewed process-runner services completed through PR #320 / merge commit `89022e08b7dccca0536e5e81e194bf7d17471475`; Phase 7 diagnostic-only native Viewport completed through PR #321 / merge commit `de60c9ac60c52f70d40bacc1bb19253e1f4d5d87`. The current candidate adds diagnostic-only Material Preview evidence with deterministic `editor_shell_material_preview_status=diagnostic_only` and `editor_shell_material_preview_native_handles_exposed=0` smoke counters while keeping material-preview GPU parity as private future adapter work. |
| Parent roadmap | [Production Completion Master Plan v1](../master-plans/2026-05-03-production-completion-master-plan-v1.md) | Parent production-completion roadmap with `unsupportedProductionGaps = []`; the native editor shell milestone is the selected developer-owned follow-up and must keep SDL3 absent, native handles private, and broad runtime/game UI claims unexpanded. |
| Completed slice | [Sandbox World Package Validation And Performance Budgets v1](2026-05-30-sandbox-world-package-validation-performance-budgets-v1.md) | Completed through PR #313 / merge commit `04cc3b0f9cb1331f1ea21b15f91f116eb3fec8cf` after local full validation and hosted `PR Gate`, `Windows MSVC`, Linux, macOS Metal CMake, iOS smoke, static analysis, `Agent Static Guards`, and CodeQL checks. It proves Win32 runtime host, D3D12 presentation, WASAPI, sandbox-world runtime/persistence/streaming, production tile renderer through `plan_tile_chunk_renderer` / `--require-production-tile-renderer`, authoring workflow, runtime UI renderer atlas handoff, installed validation, deterministic `sandbox_package_budget_*` counters, and fail-closed over-budget CTest evidence while keeping SDL3 absent, native handles hidden, native texture ownership unsupported, package mutation unsupported, broad online/modding unsupported, broad renderer quality unclaimed, and `unsupportedProductionGaps = []`. |
| Completed milestone | [Generic 2D Sandbox Production Lane v1](2026-05-27-generic-2d-sandbox-production-lane-v1.md) | Completed Phases 1-10 as reviewable slices through PR #299, PR #300, PR #301, PR #302, PR #303, PR #304, PR #308, PR #311, PR #312, and PR #313. |
...
| Parent milestone | [Production Completion Master Plan v1](../master-plans/2026-05-03-production-completion-master-plan-v1.md) | Parent production-completion roadmap. The active pointer is delegated to `Native Win32 Editor Shell v1` until that milestone is closed and the manifest returns to the next selected plan or selection gate. |
