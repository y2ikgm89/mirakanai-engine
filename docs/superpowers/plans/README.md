...
| Status | Plan | Notes |
| --- | --- | --- |
| Active slice (`currentActivePlan`) | [Sprite 9-Slice and Tiled v1](2026-05-23-sprite-9slice-and-tiled-v1.md) | 9-slice/tiled sprite metadata, scene expansion, and package-visible expansion counters. |
