...
| Status | Plan | Notes |
| --- | --- | --- |
| Active milestone (`currentActivePlan`) | [General Purpose Game Production v1](2026-05-25-general-purpose-game-production-v1.md) | Selected post-foundation production track; Phases 1-3 implement reusable gameplay runtime scheduling, world/entity ownership, and addressable content streaming, and the remaining candidates cover authoring workflows, runtime UI workbench, genre packs, network replication, and rendering/VFX/profiling surfaces. |
