...
| Status | Plan | Notes |
| --- | --- | --- |
| Active milestone (`currentActivePlan`) | [First-Party Editor Shell v1](2026-05-31-first-party-editor-shell-v1.md) | Clean-break active child plan selected by `recommendedNextPlan.id = first-party-editor-shell-v1`. It replaces the completed Dear ImGui-backed `MK_editor` shell with a first-party retained UI/editor shell, renames the validation lane from `desktop-gui` to `desktop-editor`, adds AI-operable snapshot/catalog/dry-run/apply contracts, removes active UI-middleware dependency claims, and deletes inactive Dear ImGui implementation files without compatibility shims. |
| Parent roadmap | [Production Completion Master Plan v1](../master-plans/2026-05-03-production-completion-master-plan-v1.md) | Parent production-completion index with `unsupportedProductionGaps = []`; current child selection is `first-party-editor-shell-v1` after Native Win32 Editor Shell v1 closed through PR #322. |
...
| Parent milestone | [Production Completion Master Plan v1](../master-plans/2026-05-03-production-completion-master-plan-v1.md) | Parent production-completion index with `unsupportedProductionGaps = []`; current child selection is `first-party-editor-shell-v1` for the first-party editor shell replacement. |
