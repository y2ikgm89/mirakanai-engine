...
| Status | Plan | Notes |
| --- | --- | --- |
| Active milestone (`currentActivePlan`) | [Foundation Ready Burn-down v1](2026-05-24-foundation-ready-burn-down-v1.md) | Long-running burn-down of the canonical `foundation-ready` rows. It started with 15 rows; `engine-scene-gameplay-binding-v1`, `engine-input-action-contexts-v1`, `engine-asset-placeholder-generation-v1`, `sprite-atlas-authoring-v1`, `sprite-batching-renderer-v1`, `sprite-animation-flipbook-v1`, and `material-shader-graph-production-v1` are promoted, leaving 8 rows. `unsupportedProductionGaps = []` remains the 1.0 truth. |
