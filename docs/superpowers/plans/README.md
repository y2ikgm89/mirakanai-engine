...
| Status | Plan | Notes |
| --- | --- | --- |
| Active slice (`currentActivePlan`) | [Reviewed Importers Codecs And Shader Generation v1](2026-05-27-reviewed-importers-codecs-shader-generation-v1.md) | Resumed third child of [Clean Break Broad Production Readiness Master Plan v1](../master-plans/2026-05-27-clean-break-broad-production-readiness-master-plan-v1.md). It targets reviewed importer, codec, KTX2/Basis, glTF, source image/audio, and shader generation execution lanes behind first-party contracts, optional dependency/legal gates, package counters, host/toolchain evidence, and fail-closed broad non-claims while keeping `unsupportedProductionGaps = []`. |
...
| Active master plan | [Clean Break Broad Production Readiness Master Plan v1](../master-plans/2026-05-27-clean-break-broad-production-readiness-master-plan-v1.md) | Long-running sequencing plan for broad production areas. The SDL3 removal milestone and selection-gate backlog reconciliation are closed; the composed manifest now selects `reviewed-importers-codecs-shader-generation-v1` and keeps `unsupportedProductionGaps = []`. |
