...
| Status | Plan | Notes |
| --- | --- | --- |
| Active milestone (`currentActivePlan`) | [General Purpose Game Production v1](2026-05-25-general-purpose-game-production-v1.md) | Selected post-foundation production track; Phase 1 implements reusable gameplay runtime scheduling, and the remaining candidates cover world/entity ownership, addressable content streaming, authoring workflows, runtime UI workbench, genre packs, network replication, and rendering/VFX/profiling surfaces. |
