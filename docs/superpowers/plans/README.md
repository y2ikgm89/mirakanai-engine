...
| Status | Plan | Notes |
| --- | --- | --- |
| Active milestone (`currentActivePlan`) | [Generated Game Studio v1](2026-05-26-generated-game-studio-v1.md) | Successor game-surface milestone is again the active plan after the temporary contract cleanup child completed. |
...
| Completed slice | [Engine Contract Version Suffix Cleanup](2026-05-26-engine-contract-version-suffix-cleanup.md) | Completed clean-breaking removal of removable current pre-release contract suffixes across saved formats, public C++ contracts, editor ABI/resource-capture contracts, docs, manifest fragments, generated manifest output, and static guards through stacked draft PRs #242-#245. Remaining audit hits are stale-format rejection fixtures, unknown-format fixtures, historical evidence, cleanup mapping text, external standard text, numeric version fields, or coordinate/variable false positives. |
