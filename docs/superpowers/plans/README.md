...
| Status | Plan | Notes |
| --- | --- | --- |
| Active milestone (`currentActivePlan`) | [General Purpose Game Production v1](2026-05-25-general-purpose-game-production-v1.md) | Selected post-foundation production track; Phases 1-4 implement reusable gameplay runtime scheduling, world/entity ownership, addressable content streaming, and production authoring workflow review, and the remaining candidates cover runtime UI workbench, genre packs, network replication, and rendering/VFX/profiling surfaces. |
