...
| Status | Plan | Notes |
| --- | --- | --- |
| Active slice (`currentActivePlan`) | [Runtime UI Text Platform Stack v1](2026-05-27-runtime-ui-text-platform-stack-v1.md) | Second selected child of [Clean Break Broad Production Readiness Master Plan v1](../master-plans/2026-05-27-clean-break-broad-production-readiness-master-plan-v1.md). It targets real text shaping, font rasterization, IME, accessibility, renderer atlas handoff, platform parity, optional dependency/legal gates, package counters, and host-gated non-claims behind first-party runtime UI contracts while keeping `unsupportedProductionGaps = []`. |
