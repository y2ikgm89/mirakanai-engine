...
| Status | Plan | Notes |
| --- | --- | --- |
| Active slice (`currentActivePlan`) | [Renderer Production Quality And Backend Parity v1](2026-05-27-renderer-production-quality-backend-parity-v1.md) | First selected child of [Clean Break Broad Production Readiness Master Plan v1](../master-plans/2026-05-27-clean-break-broad-production-readiness-master-plan-v1.md). It starts the official-practice, no-backward-compatibility post-1.0 breadth track with renderer backend-local production quality, parity, profiling, package, and host-gate evidence; the current checkpoint adds selected debug CPU zone / trace handoff evidence and GPU memory budget / residency pressure evidence while keeping `unsupportedProductionGaps = []`. |
...
| Clean-break broad production sequencing | [Clean Break Broad Production Readiness Master Plan v1](../master-plans/2026-05-27-clean-break-broad-production-readiness-master-plan-v1.md) and [Renderer Production Quality And Backend Parity v1](2026-05-27-renderer-production-quality-backend-parity-v1.md) |
