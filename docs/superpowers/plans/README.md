...
| Status | Plan | Notes |
| --- | --- | --- |
| Active milestone (`currentActivePlan`) | [General Purpose Game Production v1](2026-05-25-general-purpose-game-production-v1.md) | Selected post-foundation production track for reusable gameplay runtime scheduling, world/entity ownership, addressable content streaming, authoring workflows, runtime UI workbench, and genre-pack validation surfaces. |
