...
| Status | Plan | Notes |
| --- | --- | --- |
| Active slice (`currentActivePlan`) | [Production Completion Master Plan v1](../master-plans/2026-05-03-production-completion-master-plan-v1.md) | No child plan is selected. The manifest points `currentActivePlan` back to the production-completion master plan with `recommendedNextPlan.id = next-production-gap-selection` and `unsupportedProductionGaps = []` after the SDL3 removal milestone closed. |
...
| Paused slice | [Reviewed Importers Codecs And Shader Generation v1](2026-05-27-reviewed-importers-codecs-shader-generation-v1.md) | Previously selected third child of [Clean Break Broad Production Readiness Master Plan v1](../master-plans/2026-05-27-clean-break-broad-production-readiness-master-plan-v1.md). Paused when SDL3 removal was selected as the active milestone; resume only through an explicit manifest/registry switch. |
| Active master plan | [Clean Break Broad Production Readiness Master Plan v1](../master-plans/2026-05-27-clean-break-broad-production-readiness-master-plan-v1.md) | Long-running sequencing plan for broad production areas. The SDL3 removal milestone is closed in this branch; the composed manifest returns to the production-completion selection gate with `recommendedNextPlan.id = next-production-gap-selection` and `unsupportedProductionGaps = []`. |
