...
| Status | Plan | Notes |
| --- | --- | --- |
| Active milestone (`currentActivePlan`) | [Foundation Ready Burn-down v1](2026-05-24-foundation-ready-burn-down-v1.md) | Final `procedural-content-generation-v1` local implementation and validation evidence is ready through `tools/validate.ps1`; PR, merge, main sync, and guarded worktree cleanup evidence remain pending. `recommendedNextPlan.id = foundation-ready-burn-down-v1` while the publication evidence is still open. |
| Parent roadmap | [Production Completion Master Plan v1](../master-plans/2026-05-03-production-completion-master-plan-v1.md) | Active execution remains delegated to the foundation-ready burn-down milestone without reopening Engine 1.0 unsupported gaps. |
