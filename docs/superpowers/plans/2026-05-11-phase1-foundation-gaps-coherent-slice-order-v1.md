...
4. **`frame-graph-v1`** — active foundation gap; [Frame Graph RHI Texture Final State Policy v1](2026-05-16-frame-graph-rhi-texture-final-state-policy-v1.md) is complete after the postprocess and directional shadow smoke executor migrations landed. Package-visible executor evidence is the recommended next child before production pass ownership, transient allocation/aliasing, or multi-queue scheduling.
...
| `frame-graph-v1` | [2026-05-16-frame-graph-rhi-texture-pass-access-execution-v1.md](2026-05-16-frame-graph-rhi-texture-pass-access-execution-v1.md) | Completed; ordered RHI texture barrier execution now accepts writer-updated binding states and `RhiPostprocessFrameRenderer` routes scheduled inter-pass texture transitions through the executor without claiming renderer-wide pass migration |
| `frame-graph-v1` | [2026-05-16-frame-graph-shadow-smoke-execution-migration-v1.md](2026-05-16-frame-graph-shadow-smoke-execution-migration-v1.md) | Completed; `RhiDirectionalShadowSmokeFrameRenderer` scheduled inter-pass transitions/pass callbacks route through the same executor without claiming final-state policy or production graph ownership |
| `frame-graph-v1` | [2026-05-16-frame-graph-rhi-texture-final-state-policy-v1.md](2026-05-16-frame-graph-rhi-texture-final-state-policy-v1.md) | Completed; moved reusable postprocess/shadow depth final-state transitions into the RHI texture executor without claiming production graph ownership |
