...
4. **`frame-graph-v1`** — active foundation gap; [Frame Graph RHI Texture Pass Access Execution v1](2026-05-16-frame-graph-rhi-texture-pass-access-execution-v1.md) is the current child slice for ordered texture barrier execution and postprocess renderer graph-owned inter-pass transitions.
...
| `frame-graph-v1` | [2026-05-16-frame-graph-rhi-texture-pass-access-execution-v1.md](2026-05-16-frame-graph-rhi-texture-pass-access-execution-v1.md) | Active; ordered RHI texture barrier execution now accepts writer-updated binding states and `RhiPostprocessFrameRenderer` routes scheduled inter-pass texture transitions through the executor without claiming renderer-wide pass migration |
