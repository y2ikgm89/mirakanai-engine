...
- No executed GPU culling dispatch. Follow-up actual D3D12 compute dispatch is the active child plan `docs/superpowers/plans/2026-06-11-mavg-gpu-culling-dispatch-v1.md` / `mavg-gpu-culling-dispatch-v1` after MAVG Vulkan count-buffer closeout PR #553 and a separate activation PR; implementation remains fail-closed until the independent implementation PR lands.
