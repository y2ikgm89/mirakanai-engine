...
- Publication: PR #725 head `ba7dbc55` passed hosted PR Gate, Windows MSVC, Linux CMake/Coverage/ASan/Vulkan, static shards, iOS simulator, iOS Metal, macOS Metal CMake, and CodeQL, then merged to `origin/main` at merge commit `ee5c8ebf`.
