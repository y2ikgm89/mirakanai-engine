...
- `tools/validate.ps1`: passed with 44 static checks and 159/159 CTest tests in `out/validation-logs/validate-20260626-171624-46492`; broad renderer counters remained non-ready until the retained evidence assembler and final preflight are complete.
