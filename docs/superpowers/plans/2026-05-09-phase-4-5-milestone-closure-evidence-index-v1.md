...
| **4.4** | Frame graph / upload foundation narrow series | Frame Graph v0/v1 compile-only contracts and schedules (`tests/unit/renderer_rhi_tests.cpp`); Frame Graph RHI execution plans elsewhere; RHI upload stale-generation diagnostics ([2026-05-08-rhi-upload-stale-generation-diagnostics-v1.md](2026-05-08-rhi-upload-stale-generation-diagnostics-v1.md)); RHI lifetime retired-handle invalidation contract retained through tests and Git history. |
