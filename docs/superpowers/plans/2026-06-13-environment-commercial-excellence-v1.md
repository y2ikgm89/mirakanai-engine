...
- This slice still does not execute optional codec decoders at runtime, transcode Basis at runtime, call backend APIs, upload GPU textures, prove strict Vulkan/Metal texture payload parity, prove broad source-image decode coverage, promote optional dependency bootstrap, or promote `environment_asset_pipeline_openexr_ktx_basis_ready`.
