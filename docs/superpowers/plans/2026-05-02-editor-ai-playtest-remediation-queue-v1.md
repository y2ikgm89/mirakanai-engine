...
- GREEN: `pwsh -NoProfile -ExecutionPolicy Bypass -File tools/agent-context.ps1` PASS after advancing to the historical remediation handoff and evidence-review plan ids; retired follow-up literals now live in [99-historical-verdict-archive.md](../master-plans/production-completion-v1/99-historical-verdict-archive.md).
