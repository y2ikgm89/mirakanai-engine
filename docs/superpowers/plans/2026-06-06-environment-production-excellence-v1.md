...
**Status:** Active. Selected milestone. Phases 0-5, 7, and 8 are complete; Phase 5 has completed strict Vulkan rain precipitation renderer execution, strict Vulkan physical-sky package, strict Vulkan volumetric-fog renderer execution, strict Vulkan volumetric-cloud renderer execution, and strict Vulkan IBL renderer execution candidates. Remaining exact gates are strict Metal feature evidence and aggregate `environment_ready`.
