...
std::vector<EditorDockPanelCatalogRow> editor_dock_panel_catalog() {
    return {
        ...
        EditorDockPanelCatalogRow{.id = "timeline",
                                  ...
                                  .workspace_panel = true,
                                  .native_shell_panel = true},
        EditorDockPanelCatalogRow{.id = "runtime_ui_editor",
                                  .label = "Runtime UI Editor",
                                  .workspace_id = PanelId::runtime_ui_editor,
                                  .shell_chrome = false,
                                  .workspace_panel = true,
                                  .native_shell_panel = true},
    };
...
EditorDockLayout make_default_editor_dock_layout() {
    ...
    layout.nodes = {
        ...
        EditorDockNode{
            ...
            .split_ratio = 0.5F,
            .children = {},
            .tabs = {"inspector", "runtime_ui_editor", "ai_commands", "project_settings"},
