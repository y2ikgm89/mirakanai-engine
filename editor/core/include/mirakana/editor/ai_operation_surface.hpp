...
struct EditorAiOperationUxStatusDesc {
    ...
    std::string ime_parity_status;
    std::string ime_windows_tsf_status;
    std::string ime_macos_status;
    std::string ime_linux_ibus_status;
    std::string ime_linux_fcitx_status;
    std::string ime_android_status;
    std::string ime_ios_status;
