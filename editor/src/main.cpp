...
int main(int argc, char** argv) {
    ...
    if (launch.options.smoke_frames > 0) {
        ...
        const auto smoke_document = mirakana::editor::make_first_party_editor_document(app);
        const auto smoke_counters = mirakana::editor::make_first_party_editor_shell_smoke_counters(app, smoke_document);
        std::cout
            ...
            << "editor_runtime_ui_editor_panel_visible=" << (smoke_counters.runtime_ui_editor_panel_visible ? 1 : 0)
            << '\n'
            << "editor_runtime_ui_editor_hierarchy_rows=" << smoke_counters.runtime_ui_editor_hierarchy_rows << '\n'
            << "editor_runtime_ui_editor_inspector_rows=" << smoke_counters.runtime_ui_editor_inspector_rows << '\n'
            << "editor_runtime_ui_editor_style_rows=" << smoke_counters.runtime_ui_editor_style_rows << '\n'
            << "editor_runtime_ui_editor_preview_rows=" << smoke_counters.runtime_ui_editor_preview_rows << '\n'
            << "editor_runtime_ui_editor_external_engine_parity_claim="
