...
struct NativeEditorVisibleTextureCompositor::Impl {
    ...
    [[nodiscard]] NativeViewportDisplayPlan render_viewport_frame(NativeTextureDisplayAdapter& adapter,
        ...
        return plan_native_viewport_display(NativeViewportDisplayDesc{
            ...
            .metal_host_available = prepared.metal_host_available,
            .metal_command_queue_ready = prepared.metal_command_queue_ready,
            .metal_feature_set_ready = prepared.metal_feature_set_ready,
            .metal_shader_library_ready = prepared.metal_shader_library_ready,
            .metal_render_pipeline_ready = prepared.metal_render_pipeline_ready,
            .metal_texture_render_target_ready = prepared.metal_texture_render_target_ready,
            .metal_texture_shader_read_ready = prepared.metal_texture_shader_read_ready,
            .metal_sampler_state_ready = prepared.metal_sampler_state_ready,
            .metal_render_pass_ready = prepared.metal_render_pass_ready,
            .metal_drawable_present_ready = prepared.metal_drawable_present_ready,
            .metal_command_buffer_completed = prepared.metal_command_buffer_completed,
