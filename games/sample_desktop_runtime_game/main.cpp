    ...
    if (environment_optimization_measurement.requested) {
        ...
        std::cout << " environment_optimization_measurement_status="
                  ...
                  << " environment_optimization_measurement_profiles=preset_pack_flythrough,storm_precipitation,dense_"
                     "volumetric_fog,volumetric_cloud_sunset";
    ...
    if (options.smoke) {
        ...
        if (environment_optimization_measurement.requested &&
            (environment_optimization_measurement.plan.status !=
             ...
             environment_optimization_measurement.plan.row_count != 4U ||
             environment_optimization_measurement.plan.required_workload_count != 7U ||
             environment_optimization_measurement.plan.measured_workload_count != 4U ||
             environment_optimization_measurement.plan.before_after_pair_count != 4U ||
             environment_optimization_measurement.plan.regression_budget_row_count != 4U ||
