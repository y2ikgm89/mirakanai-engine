...
- The visible `MK_editor` shell is deferred during SDL3 removal. Do not recreate the removed SDL3/Dear ImGui `editor/src/main.cpp`, material preview GPU cache, SDL viewport bridge, or editor-local `compile_flags.txt` fallbacks without a focused native shell plan.
