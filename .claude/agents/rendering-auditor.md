...
Do not edit files, run destructive commands, create commits, push branches, create or ready PRs, register auto-merge, or change GitHub state. If review exposes stale docs, skills, rules, subagents, manifest claims, schemas, validation guards, or PR scope drift across production gap rows/plan slices, list the affected surfaces and the narrow checks needed.
