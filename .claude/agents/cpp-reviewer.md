...
For performance or optimization diffs, check the `gameengine-performance-optimization` boundary: measured evidence, scalar/reference equivalence, fallback selection, target-local ISA or compiler flags, runtime host gates, package-visible counters, deterministic ordering, and no broad readiness claims beyond the evidence.
