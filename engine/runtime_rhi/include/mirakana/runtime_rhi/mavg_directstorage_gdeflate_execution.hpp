...
enum class RuntimeMavgDirectStorageGDeflateDestinationKind : std::uint8_t {
    d3d12_buffer,
    d3d12_texture_region,
    d3d12_multiple_subresources_range,
};

enum class RuntimeMavgDirectStorageGDeflateExecutionSourceKind : std::uint8_t {
    file,
    memory,
};

enum class RuntimeMavgDirectStorageGDeflateExecutionStatus : std::uint8_t {
    host_evidence_required,
    blocked,
    ready,
};

enum class RuntimeMavgDirectStorageGDeflateExecutionDiagnosticCode : std::uint8_t {
    none,
    missing_official_source,
    missing_sdk_version,
    missing_stable_directstorage_11_gdeflate,
    missing_stable_directstorage_13,
    directstorage_preview_selected,
    missing_request_options_review,
    missing_gdeflate_compression_format,
    missing_source_type_review,
    missing_destination_type_review,
    reserved_request_bits_nonzero,
    missing_get_compression_support,
    missing_gpu_compression_support,
    cpu_fallback_not_gpu_execution,
    missing_gpu_compression_queue,
    missing_gpu_decompression_path,
    missing_staging_buffer_configuration,
...
struct RuntimeMavgDirectStorageGDeflateExecutionDiagnostic {
    RuntimeMavgDirectStorageGDeflateExecutionDiagnosticCode code{
        RuntimeMavgDirectStorageGDeflateExecutionDiagnosticCode::none};
    std::string message;
};

struct RuntimeMavgDirectStorageGDeflateExecutionRow {
    RuntimeMavgDirectStorageGDeflateDestinationKind destination{
        RuntimeMavgDirectStorageGDeflateDestinationKind::d3d12_buffer};
    RuntimeMavgDirectStorageGDeflateExecutionSourceKind source{
        RuntimeMavgDirectStorageGDeflateExecutionSourceKind::file};
    ...
    bool reviewed{false};
    bool ready{false};
    bool stable_directstorage_11_gdeflate_selected{false};
    bool stable_directstorage_13_selected{false};
    bool directstorage_14_preview_selected{false};
    bool request_options_reviewed{false};
    bool compression_format_gdeflate{false};
    bool source_type_reviewed{false};
    bool destination_type_reviewed{false};
    bool reserved_request_bits_zero{false};
    bool get_compression_support_queried{false};
    bool compression_support_gpu_optimized{false};
    bool compression_support_gpu_fallback{false};
    bool compression_support_cpu_fallback{false};
    bool compression_support_uses_compute_queue{false};
    bool compression_support_uses_copy_queue{false};
    bool gpu_decompression_path_selected{false};
    bool staging_buffer_configured{false};
    ...
    bool expected_decompressed_hash_ready{false};
    bool readback_hash_ready{false};
    bool readback_hash_matches_expected{false};
...
struct RuntimeMavgDirectStorageGDeflateExecutionDesc {
    std::span<const RuntimeMavgDirectStorageGDeflateExecutionRow> rows;
};

struct RuntimeMavgDirectStorageGDeflateExecutionResult {
    RuntimeMavgDirectStorageGDeflateExecutionStatus status{
        RuntimeMavgDirectStorageGDeflateExecutionStatus::host_evidence_required};
    std::vector<RuntimeMavgDirectStorageGDeflateExecutionDiagnostic> diagnostics;
    std::size_t reviewed_rows{0};
    std::size_t ready_rows{0};
    std::size_t gdeflate_execution_rows{0};
    std::size_t gpu_destination_execution_rows{0};
    std::size_t multiple_subresources_range_rows{0};
    std::size_t file_source_rows{0};
    std::size_t memory_source_rows{0};
    ...
    [[nodiscard]] bool succeeded() const noexcept {
        return status == RuntimeMavgDirectStorageGDeflateExecutionStatus::ready &&
               mavg_directstorage_gdeflate_execution_ready;
    }
};

[[nodiscard]] std::string_view runtime_mavg_directstorage_gdeflate_execution_status_label(
    RuntimeMavgDirectStorageGDeflateExecutionStatus status) noexcept;
[[nodiscard]] RuntimeMavgDirectStorageGDeflateExecutionResult
evaluate_runtime_mavg_directstorage_gdeflate_execution_evidence(
    const RuntimeMavgDirectStorageGDeflateExecutionDesc& desc);
[[nodiscard]] bool has_runtime_mavg_directstorage_gdeflate_execution_diagnostic(
