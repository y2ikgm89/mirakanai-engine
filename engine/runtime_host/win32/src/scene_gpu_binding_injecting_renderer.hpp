...
class SceneGpuBindingInjectingRenderer final : public IRenderer {
  public:
    SceneGpuBindingInjectingRenderer(
        std::unique_ptr<IRenderer> inner, runtime_scene_rhi::RuntimeSceneGpuBindingResult bindings,
        ...
        std::size_t compute_morph_queue_waits = 0, std::size_t compute_morph_skinned_dispatches = 0,
  ...
  private:
    ...
    std::vector<Win32DesktopPresentationSceneMorphMeshBinding> morph_mesh_bindings_;
