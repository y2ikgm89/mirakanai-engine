...
- Cursor users also load `.cursor/rules/*.mdc`, `.cursor/skills/`, and `.cursor/agents/`; shared truth remains `AGENTS.md` and the Codex/Claude skill/subagent pairs—update Cursor pointers when adding or renaming shared roles.
